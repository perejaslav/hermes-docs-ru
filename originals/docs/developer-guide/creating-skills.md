...
## Should it be a Skill or a Tool?[​](<#should-it-be-a-skill-or-a-tool> "Direct link to Should it be a Skill or a Tool?")
...
### Conditional Skill Activation[​](<#conditional-skill-activation> "Direct link to Conditional Skill Activation")
...
### Environment Variable Requirements[​](<#environment-variable-requirements> "Direct link to Environment Variable Requirements")
...
### Config Settings (config.yaml)[​](<#config-settings-configyaml> "Direct link to Config Settings \(config.yaml\)")
...
[code] [Skill config (from ~/.hermes/config.yaml):  
...
### Credential File Requirements (OAuth tokens, etc.)[​](<#credential-file-requirements-oauth-tokens-etc> "Direct link to Credential File Requirements \(OAuth tokens, etc.\)")
...
## Skill Guidelines[​](<#skill-guidelines> "Direct link to Skill Guidelines")
### No External Dependencies[​](<#no-external-dependencies> "Direct link to No External Dependencies")
...
### Include Helper Scripts[​](<#include-helper-scripts> "Direct link to Include Helper Scripts")
...
#### Referencing bundled scripts from SKILL.md[​](<#referencing-bundled-scripts-from-skillmd> "Direct link to Referencing bundled scripts from SKILL.md")
...
#### Inline shell snippets (opt-in)[​](<#inline-shell-snippets-opt-in> "Direct link to Inline shell snippets \(opt-in\)")
...
[/code]
## Where Should the Skill Live?[​](<#where-should-the-skill-live> "Direct link to Where Should the Skill Live?")
...
## Publishing Skills[​](<#publishing-skills> "Direct link to Publishing Skills")
### To the Skills Hub[​](<#to-the-skills-hub> "Direct link to To the Skills Hub")
[code] 
    hermes skills publish skills/my-skill --to github --repo owner/repo  
    
[/code]
### To a Custom Repository[​](<#to-a-custom-repository> "Direct link to To a Custom Repository")
...
If you want your skills to be discoverable without a GitHub-specific installer, consider serving them from a well-known endpoint in addition to publishing them in a repo or marketplace.
  * [Should it be a Skill or a Tool?](<#should-it-be-a-skill-or-a-tool>)
  * [Skill Directory Structure](<#skill-directory-structure>)
  * [SKILL.md Format](<#skillmd-format>)
    * [Platform-Specific Skills](<#platform-specific-skills>)
    * [Conditional Skill Activation](<#conditional-skill-activation>)
    * [Environment Variable Requirements](<#environment-variable-requirements>)
  * [Secure Setup on Load](<#secure-setup-on-load>)
    * [Config Settings (config.yaml)](<#config-settings-configyaml>)
    * [Credential File Requirements (OAuth tokens, etc.)](<#credential-file-requirements-oauth-tokens-etc>)
  * [Skill Guidelines](<#skill-guidelines>)
    * [No External Dependencies](<#no-external-dependencies>)
    * [Progressive Disclosure](<#progressive-disclosure>)
    * [Include Helper Scripts](<#include-helper-scripts>)
    * [Test It](<#test-it>)
  * [Where Should the Skill Live?](<#where-should-the-skill-live>)
  * [Publishing Skills](<#publishing-skills>)
    * [To the Skills Hub](<#to-the-skills-hub>)
    * [To a Custom Repository](<#to-a-custom-repository>)
