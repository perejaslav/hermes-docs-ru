...
## Step 1: Create the Built-in Tool File[​](<#step-1-create-the-built-in-tool-file> "Direct link to Step 1: Create the Built-in Tool File")
...
## Step 2: Add the Built-in Tool to a Toolset[​](<#step-2-add-the-built-in-tool-to-a-toolset> "Direct link to Step 2: Add the Built-in Tool to a Toolset")
...
[/code]
## ~~Step 3: Add Discovery Import~~ (No longer needed)[​](<#step-3-add-discovery-import-no-longer-needed> "Direct link to step-3-add-discovery-import-no-longer-needed")
...
## Async Handlers[​](<#async-handlers> "Direct link to Async Handlers")
...
## Handlers That Need task_id[​](<#handlers-that-need-task_id> "Direct link to Handlers That Need task_id")
...
[/code]
## Agent-Loop Intercepted Tools[​](<#agent-loop-intercepted-tools> "Direct link to Agent-Loop Intercepted Tools")
...
## Optional: Setup Wizard Integration[​](<#optional-setup-wizard-integration> "Direct link to Optional: Setup Wizard Integration")
...
## Checklist[​](<#checklist> "Direct link to Checklist")
  ...
  * [Overview](<#overview>)
  * [Step 1: Create the Built-in Tool File](<#step-1-create-the-built-in-tool-file>)
    * [Key Rules](<#key-rules>)
  * [Step 2: Add the Built-in Tool to a Toolset](<#step-2-add-the-built-in-tool-to-a-toolset>)
  * [~~Step 3: Add Discovery Import~~ (No longer needed)](<#step-3-add-discovery-import-no-longer-needed>)
  * [Async Handlers](<#async-handlers>)
  * [Handlers That Need task_id](<#handlers-that-need-task_id>)
  * [Agent-Loop Intercepted Tools](<#agent-loop-intercepted-tools>)
  * [Optional: Setup Wizard Integration](<#optional-setup-wizard-integration>)
  * [Checklist](<#checklist>)
