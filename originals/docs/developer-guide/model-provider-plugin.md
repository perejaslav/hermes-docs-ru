...
## Minimal example — a simple API-key provider[​](<#minimal-example--a-simple-api-key-provider> "Direct link to Minimal example — a simple API-key provider")
[code] 
...
## ProviderProfile fields[​](<#providerprofile-fields> "Direct link to ProviderProfile fields")
...
## Overridable hooks[​](<#overridable-hooks> "Direct link to Overridable hooks")
...
[/code]
## Hook reference examples[​](<#hook-reference-examples> "Direct link to Hook reference examples")
...
## User overrides — replace a built-in without editing the repo[​](<#user-overrides--replace-a-built-in-without-editing-the-repo> "Direct link to User overrides — replace a built-in without editing the repo")
...
## api_mode selection[​](<#api_mode-selection> "Direct link to api_mode selection")
...
## Auth types[​](<#auth-types> "Direct link to Auth types")
...
## Discovery timing[​](<#discovery-timing> "Direct link to Discovery timing")
...
[/code]
## General PluginManager integration[​](<#general-pluginmanager-integration> "Direct link to General PluginManager integration")
...
## Related pages[​](<#related-pages> "Direct link to Related pages")
  ...
  * [Minimal example — a simple API-key provider](<#minimal-example--a-simple-api-key-provider>)
  * [ProviderProfile fields](<#providerprofile-fields>)
  * [Overridable hooks](<#overridable-hooks>)
  * [Hook reference examples](<#hook-reference-examples>)
  * [User overrides — replace a built-in without editing the repo](<#user-overrides--replace-a-built-in-without-editing-the-repo>)
  * [api_mode selection](<#api_mode-selection>)
  * [Auth types](<#auth-types>)
  * [Discovery timing](<#discovery-timing>)
  * [Testing your plugin](<#testing-your-plugin>)
  * [General PluginManager integration](<#general-pluginmanager-integration>)
