...
## Cached system prompt layers[​](<#cached-system-prompt-layers> "Direct link to Cached system prompt layers")
...
### Concrete example: assembled system prompt[​](<#concrete-example-assembled-system-prompt> "Direct link to Concrete example: assembled system prompt")
...
[/code]
## How SOUL.md appears in the prompt[​](<#how-soulmd-appears-in-the-prompt> "Direct link to How SOUL.md appears in the prompt")
...
[/code]
## How context files are injected[​](<#how-context-files-are-injected> "Direct link to How context files are injected")
...
[/code]
### Context file discovery details[​](<#context-file-discovery-details> "Direct link to Context file discovery details")
...
## API-call-time-only layers[​](<#api-call-time-only-layers> "Direct link to API-call-time-only layers")
These are intentionally _not_ persisted as part of the cached system prompt:
...
## Memory snapshots[​](<#memory-snapshots> "Direct link to Memory snapshots")
...
## Skills index[​](<#skills-index> "Direct link to Skills index")
The skills system contributes a compact skills index to the prompt when skills tooling is available.
## Supported prompt customization surfaces[​](<#supported-prompt-customization-surfaces> "Direct link to Supported prompt customization surfaces")
...
### Use these surfaces first[​](<#use-these-surfaces-first> "Direct link to Use these surfaces first")
...
### When to edit code instead[​](<#when-to-edit-code-instead> "Direct link to When to edit code instead")
...
## Why prompt assembly is split this way[​](<#why-prompt-assembly-is-split-this-way> "Direct link to Why prompt assembly is split this way")
...
## Related docs[​](<#related-docs> "Direct link to Related docs")
  ...
  * [Cached system prompt layers](<#cached-system-prompt-layers>)
    * [Concrete example: assembled system prompt](<#concrete-example-assembled-system-prompt>)
  * [How SOUL.md appears in the prompt](<#how-soulmd-appears-in-the-prompt>)
  * [How context files are injected](<#how-context-files-are-injected>)
    * [Context file discovery details](<#context-file-discovery-details>)
  * [API-call-time-only layers](<#api-call-time-only-layers>)
  * [Memory snapshots](<#memory-snapshots>)
  * [Context files](<#context-files>)
  * [Skills index](<#skills-index>)
  * [Supported prompt customization surfaces](<#supported-prompt-customization-surfaces>)
    * [Use these surfaces first](<#use-these-surfaces-first>)
    * [When to edit code instead](<#when-to-edit-code-instead>)
  * [Why prompt assembly is split this way](<#why-prompt-assembly-is-split-this-way>)
