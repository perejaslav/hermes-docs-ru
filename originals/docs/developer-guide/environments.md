...
Quick Links
  ...
  * **Want to train with RL?** See [RL Training Tools](</docs/user-guide/features/rl-training>) for the agent-driven interface, or [Running Environments](<#running-environments>) for manual execution
...
### BaseEnv (Atropos)[​](<#baseenv-atropos> "Direct link to BaseEnv \(Atropos\)")
...
### HermesAgentBaseEnv[​](<#hermesagentbaseenv> "Direct link to HermesAgentBaseEnv")
...
### Concrete Environments[​](<#concrete-environments> "Direct link to Concrete Environments")
...
### Tool Call Parsers[​](<#tool-call-parsers> "Direct link to Tool Call Parsers")
...
## Available Benchmarks[​](<#available-benchmarks> "Direct link to Available Benchmarks")
### TerminalBench2[​](<#terminalbench2> "Direct link to TerminalBench2")
...
### TBLite (OpenThoughts Terminal Bench Lite)[​](<#tblite-openthoughts-terminal-bench-lite> "Direct link to TBLite \(OpenThoughts Terminal Bench Lite\)")
...
### YC-Bench[​](<#yc-bench> "Direct link to YC-Bench")
...
## Training Environments[​](<#training-environments> "Direct link to Training Environments")
### TerminalTestEnv[​](<#terminaltestenv> "Direct link to TerminalTestEnv")
...
[/code]
### HermesSweEnv[​](<#hermessweenv> "Direct link to HermesSweEnv")
...
[/code]
## Running Environments[​](<#running-environments> "Direct link to Running Environments")
Every environment is a standalone Python script with three CLI subcommands:
### `evaluate` — Run a benchmark[​](<#evaluate--run-a-benchmark> "Direct link to evaluate--run-a-benchmark")
...
### `process` — Generate SFT data[​](<#process--generate-sft-data> "Direct link to process--generate-sft-data")
...
### `serve` — Connect to Atropos for RL training[​](<#serve--connect-to-atropos-for-rl-training> "Direct link to serve--connect-to-atropos-for-rl-training")
...
## Two-Phase Operation[​](<#two-phase-operation> "Direct link to Two-Phase Operation")
### Phase 1: OpenAI Server (Eval / SFT)[​](<#phase-1-openai-server-eval--sft> "Direct link to Phase 1: OpenAI Server \(Eval / SFT\)")
...
### Phase 2: VLLM ManagedServer (Full RL)[​](<#phase-2-vllm-managedserver-full-rl> "Direct link to Phase 2: VLLM ManagedServer \(Full RL\)")
...
## Creating Environments[​](<#creating-environments> "Direct link to Creating Environments")
### Training Environment[​](<#training-environment> "Direct link to Training Environment")
[code] 
...
[/code]
### Eval-Only Benchmark[​](<#eval-only-benchmark> "Direct link to Eval-Only Benchmark")
...
### HermesAgentEnvConfig Fields[​](<#hermesagentenvconfig-fields> "Direct link to HermesAgentEnvConfig Fields")
...
### For all environments[​](<#for-all-environments> "Direct link to For all environments")
  * Python >= 3.11
...
### For Modal-sandboxed benchmarks (TB2, TBLite)[​](<#for-modal-sandboxed-benchmarks-tb2-tblite> "Direct link to For Modal-sandboxed benchmarks \(TB2, TBLite\)")
...
See [RL Training](</docs/user-guide/features/rl-training>) for the agent-driven RL workflow.
...
[/code]
  * [Architecture](<#architecture>)
    ...
    * [Concrete Environments](<#concrete-environments>)
  * [Core Components](<#core-components>)
    * [Agent Loop](<#agent-loop>)
    * [Tool Context](<#tool-context>)
    * [Tool Call Parsers](<#tool-call-parsers>)
  ...
  * [Running Environments](<#running-environments>)
    * [`evaluate` — Run a benchmark](<#evaluate--run-a-benchmark>)
    * [`process` — Generate SFT data](<#process--generate-sft-data>)
    * [`serve` — Connect to Atropos for RL training](<#serve--connect-to-atropos-for-rl-training>)
  * [Two-Phase Operation](<#two-phase-operation>)
    * [Phase 1: OpenAI Server (Eval / SFT)](<#phase-1-openai-server-eval--sft>)
    * [Phase 2: VLLM ManagedServer (Full RL)](<#phase-2-vllm-managedserver-full-rl>)
  * [Creating Environments](<#creating-environments>)
    * [Training Environment](<#training-environment>)
    * [Eval-Only Benchmark](<#eval-only-benchmark>)
  * [Configuration Reference](<#configuration-reference>)
    * [HermesAgentEnvConfig Fields](<#hermesagentenvconfig-fields>)
    * [YAML Configuration](<#yaml-configuration>)
  * [Prerequisites](<#prerequisites>)
    * [For all environments](<#for-all-environments>)
    * [For Modal-sandboxed benchmarks (TB2, TBLite)](<#for-modal-sandboxed-benchmarks-tb2-tblite>)
    * [For YC-Bench](<#for-yc-bench>)
    * [For RL training](<#for-rl-training>)
