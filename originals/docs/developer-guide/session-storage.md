...
### Sessions Table[​](<#sessions-table> "Direct link to Sessions Table")
[code] 
...
[/code]
### Messages Table[​](<#messages-table> "Direct link to Messages Table")
[code] 
...
### FTS5 Full-Text Search[​](<#fts5-full-text-search> "Direct link to FTS5 Full-Text Search")
[code] 
...
[/code]
## Schema Version and Migrations[​](<#schema-version-and-migrations> "Direct link to Schema Version and Migrations")
...
## Write Contention Handling[​](<#write-contention-handling> "Direct link to Write Contention Handling")
...
[/code]
### Create and Manage Sessions[​](<#create-and-manage-sessions> "Direct link to Create and Manage Sessions")
[code] 
...
[/code]
### Store Messages[​](<#store-messages> "Direct link to Store Messages")
[code] 
...
[/code]
### Session Titles[​](<#session-titles> "Direct link to Session Titles")
[code] 
...
[/code]
### Search Results Format[​](<#search-results-format> "Direct link to Search Results Format")
...
## Session Lineage[​](<#session-lineage> "Direct link to Session Lineage")
...
### Query: Find Session Lineage[​](<#query-find-session-lineage> "Direct link to Query: Find Session Lineage")
[code] 
...
[/code]
### Query: Recent Sessions with Preview[​](<#query-recent-sessions-with-preview> "Direct link to Query: Recent Sessions with Preview")
[code] 
    SELECT s.*,  
        COALESCE(  
...
[/code]
### Query: Token Usage Statistics[​](<#query-token-usage-statistics> "Direct link to Query: Token Usage Statistics")
[code] 
...
[/code]
## Export and Cleanup[​](<#export-and-cleanup> "Direct link to Export and Cleanup")
[code] 
...
[/code]
## Database Location[​](<#database-location> "Direct link to Database Location")
...
The database file, WAL file (`state.db-wal`), and shared-memory file (`state.db-shm`) are all created in the same directory.
  ...
  * [Schema Version and Migrations](<#schema-version-and-migrations>)
  * [Write Contention Handling](<#write-contention-handling>)
  ...
  * [Session Lineage](<#session-lineage>)
    * [Query: Find Session Lineage](<#query-find-session-lineage>)
    * [Query: Recent Sessions with Preview](<#query-recent-sessions-with-preview>)
    * [Query: Token Usage Statistics](<#query-token-usage-statistics>)
