...
[PR #12550](<https://github.com/NousResearch/hermes-agent/pull/12550>) proposed a stateless `browser_dialog` wrapper. That doesn't solve detection — it's a cleaner CDP call for when the agent already knows (via symptoms) that a dialog is open. Closed as superseded.
## Backend capability matrix (verified live 2026-04-23)[​](<#backend-capability-matrix-verified-live-2026-04-23> "Direct link to Backend capability matrix \(verified live 2026-04-23\)")
...
### CDPSupervisor[​](<#cdpsupervisor> "Direct link to CDPSupervisor")
...
### Dialog policy[​](<#dialog-policy> "Direct link to Dialog policy")
...
## Agent surface (PR 1)[​](<#agent-surface-pr-1> "Direct link to Agent surface \(PR 1\)")
### One new tool[​](<#one-new-tool> "Direct link to One new tool")
[code] 
...
### `browser_snapshot` extension[​](<#browser_snapshot-extension> "Direct link to browser_snapshot-extension")
...
### Availability gating[​](<#availability-gating> "Direct link to Availability gating")
...
## Cross-origin iframe interaction[​](<#cross-origin-iframe-interaction> "Direct link to Cross-origin iframe interaction")
...
## Camofox (follow-up)[​](<#camofox-follow-up> "Direct link to Camofox \(follow-up\)")
...
## Files touched (PR 1)[​](<#files-touched-pr-1> "Direct link to Files touched \(PR 1\)")
...
Unit tests use an asyncio mock CDP server that speaks enough of the protocol to exercise all state transitions: attach, enable, navigate, dialog fire, dialog dismiss, frame attach/detach, child target attach, session teardown. Real-backend E2E (Browserbase + local Chrome) is manual; probe scripts from the 2026-04-23 investigation kept in-repo under `scripts/browser_supervisor_e2e.py` so anyone can re-verify on new backend versions.
  * [Problem](<#problem>)
  * [Backend capability matrix (verified live 2026-04-23)](<#backend-capability-matrix-verified-live-2026-04-23>)
  * [Architecture](<#architecture>)
    * [CDPSupervisor](<#cdpsupervisor>)
    * [Lifecycle](<#lifecycle>)
    * [Dialog policy](<#dialog-policy>)
  * [Agent surface (PR 1)](<#agent-surface-pr-1>)
    * [One new tool](<#one-new-tool>)
    * [`browser_snapshot` extension](<#browser_snapshot-extension>)
    * [Availability gating](<#availability-gating>)
  * [Cross-origin iframe interaction](<#cross-origin-iframe-interaction>)
  * [Camofox (follow-up)](<#camofox-follow-up>)
  * [Files touched (PR 1)](<#files-touched-pr-1>)
    * [New](<#new>)
    * [Modified](<#modified>)
  * [Non-goals](<#non-goals>)
  * [Testing](<#testing>)
