...
## Core Responsibilities[​](<#core-responsibilities> "Direct link to Core Responsibilities")
...
## Two Entry Points[​](<#two-entry-points> "Direct link to Two Entry Points")
[code] 
...
## API Modes[​](<#api-modes> "Direct link to API Modes")
...
## Turn Lifecycle[​](<#turn-lifecycle> "Direct link to Turn Lifecycle")
...
### Message Alternation Rules[​](<#message-alternation-rules> "Direct link to Message Alternation Rules")
...
## Interruptible API Calls[​](<#interruptible-api-calls> "Direct link to Interruptible API Calls")
...
## Tool Execution[​](<#tool-execution> "Direct link to Tool Execution")
### Sequential vs Concurrent[​](<#sequential-vs-concurrent> "Direct link to Sequential vs Concurrent")
...
[/code]
### Agent-Level Tools[​](<#agent-level-tools> "Direct link to Agent-Level Tools")
...
## Callback Surfaces[​](<#callback-surfaces> "Direct link to Callback Surfaces")
...
## Budget and Fallback Behavior[​](<#budget-and-fallback-behavior> "Direct link to Budget and Fallback Behavior")
### Iteration Budget[​](<#iteration-budget> "Direct link to Iteration Budget")
...
## Compression and Persistence[​](<#compression-and-persistence> "Direct link to Compression and Persistence")
### When Compression Triggers[​](<#when-compression-triggers> "Direct link to When Compression Triggers")
...
### What Happens During Compression[​](<#what-happens-during-compression> "Direct link to What Happens During Compression")
...
## Key Source Files[​](<#key-source-files> "Direct link to Key Source Files")
File| Purpose  
---|---  
...
## Related Docs[​](<#related-docs> "Direct link to Related Docs")
  ...
  * [Turn Lifecycle](<#turn-lifecycle>)
    ...
    * [Message Alternation Rules](<#message-alternation-rules>)
  * [Interruptible API Calls](<#interruptible-api-calls>)
  * [Tool Execution](<#tool-execution>)
    * [Sequential vs Concurrent](<#sequential-vs-concurrent>)
    * [Execution Flow](<#execution-flow>)
    * [Agent-Level Tools](<#agent-level-tools>)
  * [Callback Surfaces](<#callback-surfaces>)
  * [Budget and Fallback Behavior](<#budget-and-fallback-behavior>)
    * [Iteration Budget](<#iteration-budget>)
    * [Fallback Model](<#fallback-model>)
  * [Compression and Persistence](<#compression-and-persistence>)
    * [When Compression Triggers](<#when-compression-triggers>)
    * [What Happens During Compression](<#what-happens-during-compression>)
