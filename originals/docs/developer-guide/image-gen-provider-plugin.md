...
## The ImageGenProvider ABC[​](<#the-imagegenprovider-abc> "Direct link to The ImageGenProvider ABC")
...
## ABC reference[​](<#abc-reference> "Direct link to ABC reference")
...
## Handling base64 vs URL output[​](<#handling-base64-vs-url-output> "Direct link to Handling base64 vs URL output")
...
## User overrides[​](<#user-overrides> "Direct link to User overrides")
...
## Related pages[​](<#related-pages> "Direct link to Related pages")
  ...
  * [The ImageGenProvider ABC](<#the-imagegenprovider-abc>)
  * [plugin.yaml](<#pluginyaml>)
  * [ABC reference](<#abc-reference>)
  * [Response format](<#response-format>)
  * [Handling base64 vs URL output](<#handling-base64-vs-url-output>)
