...
If you are trying to add a new first-class inference provider, read [Adding Providers](</docs/developer-guide/adding-providers>) and the [Model Provider Plugin guide](</docs/developer-guide/model-provider-plugin>) alongside this page.
## Resolution precedence[​](<#resolution-precedence> "Direct link to Resolution precedence")
...
## Output of runtime resolution[​](<#output-of-runtime-resolution> "Direct link to Output of runtime resolution")
...
## AI Gateway[​](<#ai-gateway> "Direct link to AI Gateway")
...
## OpenRouter, AI Gateway, and custom OpenAI-compatible base URLs[​](<#openrouter-ai-gateway-and-custom-openai-compatible-base-urls> "Direct link to OpenRouter, AI Gateway, and custom OpenAI-compatible base URLs")
...
## Native Anthropic path[​](<#native-anthropic-path> "Direct link to Native Anthropic path")
...
## OpenAI Codex path[​](<#openai-codex-path> "Direct link to OpenAI Codex path")
Codex uses a separate Responses API path:
  * `api_mode = codex_responses`
  * dedicated credential resolution and auth store support


## Auxiliary model routing[​](<#auxiliary-model-routing> "Direct link to Auxiliary model routing")
...
## Fallback models[​](<#fallback-models> "Direct link to Fallback models")
...
### What does NOT support fallback[​](<#what-does-not-support-fallback> "Direct link to What does NOT support fallback")
...
Cron jobs **do** support fallback: `run_job()` reads `fallback_providers` (or legacy `fallback_model`) from `config.yaml` and passes it to `AIAgent(fallback_model=...)`, matching the gateway's `_load_fallback_model()` pattern. See [Cron Internals](</docs/developer-guide/cron-internals>).
### Test coverage[​](<#test-coverage> "Direct link to Test coverage")
...
## Related docs[​](<#related-docs> "Direct link to Related docs")
  ...
  * [Providers](<#providers>)
  * [Output of runtime resolution](<#output-of-runtime-resolution>)
  * [Why this matters](<#why-this-matters>)
  * [AI Gateway](<#ai-gateway>)
  * [OpenRouter, AI Gateway, and custom OpenAI-compatible base URLs](<#openrouter-ai-gateway-and-custom-openai-compatible-base-urls>)
  * [Native Anthropic path](<#native-anthropic-path>)
  * [OpenAI Codex path](<#openai-codex-path>)
  * [Auxiliary model routing](<#auxiliary-model-routing>)
  * [Fallback models](<#fallback-models>)
    * [How it works internally](<#how-it-works-internally>)
    * [What does NOT support fallback](<#what-does-not-support-fallback>)
