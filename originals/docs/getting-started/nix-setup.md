...
* * *
## Quick Start (Any Nix User)[​](<#quick-start-any-nix-user> "Direct link to Quick Start \(Any Nix User\)")
...
[/code]
* * *
## NixOS Module[​](<#nixos-module> "Direct link to NixOS Module")
...
### Add the Flake Input[​](<#add-the-flake-input> "Direct link to Add the Flake Input")
[code] 
...
### Container-aware CLI[​](<#container-aware-cli> "Direct link to Container-aware CLI")
info
...
[/code]
### Choosing a Deployment Mode[​](<#choosing-a-deployment-mode> "Direct link to Choosing a Deployment Mode")
...
### Declarative Settings[​](<#declarative-settings> "Direct link to Declarative Settings")
...
[/code]
### Escape Hatch: Bring Your Own Config[​](<#escape-hatch-bring-your-own-config> "Direct link to Escape Hatch: Bring Your Own Config")
...
### Customization Cheatsheet[​](<#customization-cheatsheet> "Direct link to Customization Cheatsheet")
...
### sops-nix[​](<#sops-nix> "Direct link to sops-nix")
[code] 
    {  
      sops = {  
...
[/code]
### agenix[​](<#agenix> "Direct link to agenix")
[code] 
    {  
...
[/code]
### OAuth / Auth Seeding[​](<#oauth--auth-seeding> "Direct link to OAuth / Auth Seeding")
...
### Stdio Transport (Local Servers)[​](<#stdio-transport-local-servers> "Direct link to Stdio Transport \(Local Servers\)")
[code] 
    {  
...
### HTTP Transport (Remote Servers)[​](<#http-transport-remote-servers> "Direct link to HTTP Transport \(Remote Servers\)")
[code] 
    {  
...
[/code]
### HTTP Transport with OAuth[​](<#http-transport-with-oauth> "Direct link to HTTP Transport with OAuth")
...
[/code]
### Sampling (Server-Initiated LLM Requests)[​](<#sampling-server-initiated-llm-requests> "Direct link to Sampling \(Server-Initiated LLM Requests\)")
...
[/code]
* * *
## Managed Mode[​](<#managed-mode> "Direct link to Managed Mode")
...
* * *
## Container Architecture[​](<#container-architecture> "Direct link to Container Architecture")
info
...
### What Persists Across What[​](<#what-persists-across-what> "Direct link to What Persists Across What")
...
### GC Root Protection[​](<#gc-root-protection> "Direct link to GC Root Protection")
...
### Directory Plugins (`extraPlugins`)[​](<#directory-plugins-extraplugins> "Direct link to directory-plugins-extraplugins")
...
### Entry-Point Plugins (`extraPythonPackages`)[​](<#entry-point-plugins-extrapythonpackages> "Direct link to entry-point-plugins-extrapythonpackages")
...
### Combining Both[​](<#combining-both> "Direct link to Combining Both")
...
[/code]
### Using the Overlay[​](<#using-the-overlay> "Direct link to Using the Overlay")
...
### Dev Shell[​](<#dev-shell> "Direct link to Dev Shell")
...
[/code]
### direnv (Recommended)[​](<#direnv-recommended> "Direct link to direnv \(Recommended\)")
...
[/code]
### Flake Checks[​](<#flake-checks> "Direct link to Flake Checks")
...
### Secrets & Environment[​](<#secrets--environment> "Direct link to Secrets & Environment")
Option| Type| Default| Description  
---|---|---|---  
...
### Documents[​](<#documents-1> "Direct link to Documents")
Option| Type| Default| Description  
---|---|---|---  
...
### MCP Servers[​](<#mcp-servers-1> "Direct link to MCP Servers")
Option| Type| Default| Description  
---|---|---|---  
...
### Service Behavior[​](<#service-behavior> "Direct link to Service Behavior")
Option| Type| Default| Description  
---|---|---|---  
...
### Native Mode[​](<#native-mode> "Direct link to Native Mode")
[code] 
...
[/code]
### Container Mode[​](<#container-mode> "Direct link to Container Mode")
...
### Service Logs[​](<#service-logs> "Direct link to Service Logs")
[code] 
...
[/code]
### Container Inspection[​](<#container-inspection> "Direct link to Container Inspection")
[code] 
    systemctl status hermes-agent  
...
[/code]
### Force Container Recreation[​](<#force-container-recreation> "Direct link to Force Container Recreation")
...
[/code]
### Verify Secrets Are Loaded[​](<#verify-secrets-are-loaded> "Direct link to Verify Secrets Are Loaded")
...
[/code]
### GC Root Verification[​](<#gc-root-verification> "Direct link to GC Root Verification")
[code] 
...
Tool added via `extraPackages` not found in terminal| Requires `nixos-rebuild switch` to update the per-user profile| Rebuild and restart: `nixos-rebuild switch && systemctl restart hermes-agent`  
  ...
  * [Quick Start (Any Nix User)](<#quick-start-any-nix-user>)
  * [NixOS Module](<#nixos-module>)
    * [Add the Flake Input](<#add-the-flake-input>)
    * [Minimal Configuration](<#minimal-configuration>)
    * [Container-aware CLI](<#container-aware-cli>)
    * [Verify It Works](<#verify-it-works>)
    * [Choosing a Deployment Mode](<#choosing-a-deployment-mode>)
  * [Configuration](<#configuration>)
    * [Declarative Settings](<#declarative-settings>)
    * [Escape Hatch: Bring Your Own Config](<#escape-hatch-bring-your-own-config>)
    * [Customization Cheatsheet](<#customization-cheatsheet>)
  * [Secrets Management](<#secrets-management>)
    * [sops-nix](<#sops-nix>)
    * [agenix](<#agenix>)
    * [OAuth / Auth Seeding](<#oauth--auth-seeding>)
  * [Documents](<#documents>)
  * [MCP Servers](<#mcp-servers>)
    * [Stdio Transport (Local Servers)](<#stdio-transport-local-servers>)
    * [HTTP Transport (Remote Servers)](<#http-transport-remote-servers>)
    * [HTTP Transport with OAuth](<#http-transport-with-oauth>)
    * [Sampling (Server-Initiated LLM Requests)](<#sampling-server-initiated-llm-requests>)
  * [Managed Mode](<#managed-mode>)
  * [Container Architecture](<#container-architecture>)
    * [What Persists Across What](<#what-persists-across-what>)
    * [GC Root Protection](<#gc-root-protection>)
  * [Plugins](<#plugins>)
    * [Directory Plugins (`extraPlugins`)](<#directory-plugins-extraplugins>)
    * [Entry-Point Plugins (`extraPythonPackages`)](<#entry-point-plugins-extrapythonpackages>)
    * [Combining Both](<#combining-both>)
    * [Using the Overlay](<#using-the-overlay>)
    * [Plugin Configuration](<#plugin-configuration>)
  * [Development](<#development>)
    * [Dev Shell](<#dev-shell>)
    * [direnv (Recommended)](<#direnv-recommended>)
  ...
  * [Troubleshooting](<#troubleshooting>)
    ...
    * [Force Container Recreation](<#force-container-recreation>)
    * [Verify Secrets Are Loaded](<#verify-secrets-are-loaded>)
    * [GC Root Verification](<#gc-root-verification>)
