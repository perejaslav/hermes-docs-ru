...
## Inference Providers[​](<#inference-providers> "Direct link to Inference Providers")
...
### Google Gemini via OAuth (`google-gemini-cli`)[​](<#google-gemini-via-oauth-google-gemini-cli> "Direct link to google-gemini-via-oauth-google-gemini-cli")
...
**How inference works:**
  * Traffic goes to `https://cloudcode-pa.googleapis.com/v1internal:generateContent` (or `:streamGenerateContent?alt=sse` for streaming), NOT the paid `v1beta/openai` endpoint
  * Request body wrapped `{project, model, user_prompt_id, request}`
  * OpenAI-shaped `messages[]`, `tools[]`, `tool_choice` are translated to Gemini's native `contents[]`, `tools[].functionDeclarations`, `toolConfig` shape
...
[/code]
Register a **Desktop app** OAuth client at [console.cloud.google.com/apis/credentials](<https://console.cloud.google.com/apis/credentials>) with the Generative Language API enabled.
Codex Note
...
### Two Commands for Model Management[​](<#two-commands-for-model-management> "Direct link to Two Commands for Model Management")
...
### Anthropic (Native)[​](<#anthropic-native> "Direct link to Anthropic \(Native\)")
...
### First-Class API-Key Providers[​](<#first-class-api-key-providers> "Direct link to First-Class API-Key Providers")
...
### xAI (Grok) — Responses API + Prompt Caching[​](<#xai-grok--responses-api--prompt-caching> "Direct link to xAI \(Grok\) — Responses API + Prompt Caching")
...
### Ollama Cloud — Managed Ollama Models, OAuth + API Key[​](<#ollama-cloud--managed-ollama-models-oauth--api-key> "Direct link to Ollama Cloud — Managed Ollama Models, OAuth + API Key")
...
### Qwen Portal (OAuth)[​](<#qwen-portal-oauth> "Direct link to Qwen Portal \(OAuth\)")
...
### Alibaba Coding Plan[​](<#alibaba-coding-plan> "Direct link to Alibaba Coding Plan")
...
### MiniMax (OAuth)[​](<#minimax-oauth> "Direct link to MiniMax \(OAuth\)")
...
### NVIDIA NIM[​](<#nvidia-nim> "Direct link to NVIDIA NIM")
...
### GMI Cloud[​](<#gmi-cloud> "Direct link to GMI Cloud")
...
### StepFun[​](<#stepfun> "Direct link to StepFun")
...
### Hugging Face Inference Providers[​](<#hugging-face-inference-providers> "Direct link to Hugging Face Inference Providers")
...
## Custom & Self-Hosted LLM Providers[​](<#custom--self-hosted-llm-providers> "Direct link to Custom & Self-Hosted LLM Providers")
...
### Switching Models with `/model`[​](<#switching-models-with-model> "Direct link to switching-models-with-model")
...
* * *
### Ollama — Local Models, Zero Config[​](<#ollama--local-models-zero-config> "Direct link to Ollama — Local Models, Zero Config")
...
* * *
### vLLM — High-Performance GPU Inference[​](<#vllm--high-performance-gpu-inference> "Direct link to vLLM — High-Performance GPU Inference")
...
* * *
### SGLang — Fast Serving with RadixAttention[​](<#sglang--fast-serving-with-radixattention> "Direct link to SGLang — Fast Serving with RadixAttention")
...
* * *
### llama.cpp / llama-server — CPU & Metal Inference[​](<#llamacpp--llama-server--cpu--metal-inference> "Direct link to llama.cpp / llama-server — CPU & Metal Inference")
...
* * *
### LM Studio — Desktop App with Local Models[​](<#lm-studio--desktop-app-with-local-models> "Direct link to LM Studio — Desktop App with Local Models")
...
* * *
### WSL2 Networking (Windows Users)[​](<#wsl2-networking-windows-users> "Direct link to WSL2 Networking \(Windows Users\)")
...
#### Option 1: Mirrored Networking Mode (Recommended)[​](<#option-1-mirrored-networking-mode-recommended> "Direct link to Option 1: Mirrored Networking Mode \(Recommended\)")
...
[code] curl http://localhost:11434/v1/models   # Ollama on Windows — works  
...
[/code]
#### Option 2: Use the Windows Host IP (Windows 10 / older builds)[​](<#option-2-use-the-windows-host-ip-windows-10--older-builds> "Direct link to Option 2: Use the Windows Host IP \(Windows 10 / older builds\)")
...
[/code]
#### Server Bind Address (Required for NAT Mode)[​](<#server-bind-address-required-for-nat-mode> "Direct link to Server Bind Address \(Required for NAT Mode\)")
...
* * *
### Troubleshooting Local Models[​](<#troubleshooting-local-models> "Direct link to Troubleshooting Local Models")
These issues affect **all** local inference servers when used with Hermes.
#### "Connection refused" from WSL2 to a Windows-hosted model server[​](<#connection-refused-from-wsl2-to-a-windows-hosted-model-server> "Direct link to "Connection refused" from WSL2 to a Windows-hosted model server")
...
#### Tool calls appear as text instead of executing[​](<#tool-calls-appear-as-text-instead-of-executing> "Direct link to Tool calls appear as text instead of executing")
...
#### Model seems to forget context or give incoherent responses[​](<#model-seems-to-forget-context-or-give-incoherent-responses> "Direct link to Model seems to forget context or give incoherent responses")
...
#### "Context limit: 2048 tokens" at startup[​](<#context-limit-2048-tokens-at-startup> "Direct link to "Context limit: 2048 tokens" at startup")
...
[/code]
#### Responses get cut off mid-sentence[​](<#responses-get-cut-off-mid-sentence> "Direct link to Responses get cut off mid-sentence")
**Possible causes:**
...
* * *
### LiteLLM Proxy — Multi-Provider Gateway[​](<#litellm-proxy--multi-provider-gateway> "Direct link to LiteLLM Proxy — Multi-Provider Gateway")
...
[/code]
* * *
### ClawRouter — Cost-Optimized Routing[​](<#clawrouter--cost-optimized-routing> "Direct link to ClawRouter — Cost-Optimized Routing")
...
* * *
### Other Compatible Providers[​](<#other-compatible-providers> "Direct link to Other Compatible Providers")
...
[/code]
* * *
### Context Length Detection[​](<#context-length-detection> "Direct link to Context Length Detection")
...
* * *
### Named Custom Providers[​](<#named-custom-providers> "Direct link to Named Custom Providers")
...
* * *
### Cookbook: Together AI, Groq, Perplexity[​](<#cookbook-together-ai-groq-perplexity> "Direct link to Cookbook: Together AI, Groq, Perplexity")
...
[/code]
#### Perplexity[​](<#perplexity> "Direct link to Perplexity")
...
[/code]
#### Multiple providers in one config[​](<#multiple-providers-in-one-config> "Direct link to Multiple providers in one config")
...
* * *
### Choosing the Right Setup[​](<#choosing-the-right-setup> "Direct link to Choosing the Right Setup")
...
## Optional API Keys[​](<#optional-api-keys> "Direct link to Optional API Keys")
...
### Self-Hosting Firecrawl[​](<#self-hosting-firecrawl> "Direct link to Self-Hosting Firecrawl")
...
## OpenRouter Provider Routing[​](<#openrouter-provider-routing> "Direct link to OpenRouter Provider Routing")
...
## Fallback Model[​](<#fallback-model> "Direct link to Fallback Model")
...
## See Also[​](<#see-also> "Direct link to See Also")
  ...
  * [Inference Providers](<#inference-providers>)
    ...
    * [First-Class API-Key Providers](<#first-class-api-key-providers>)
  ...
  * [Custom & Self-Hosted LLM Providers](<#custom--self-hosted-llm-providers>)
    ...
    * [Cookbook: Together AI, Groq, Perplexity](<#cookbook-together-ai-groq-perplexity>)
