...
[/code]
## Voice Messages (STT)[​](<#voice-messages-stt> "Direct link to Voice Messages \(STT\)")
...
### Bot disconnects immediately (quick disconnect)[​](<#bot-disconnects-immediately-quick-disconnect> "Direct link to Bot disconnects immediately \(quick disconnect\)")
This usually means:
...
### Voice messages not transcribed[​](<#voice-messages-not-transcribed> "Direct link to Voice messages not transcribed")
...
### Messages not delivered[​](<#messages-not-delivered> "Direct link to Messages not delivered")
