...
### Discord Gateway Model[​](<#discord-gateway-model> "Direct link to Discord Gateway Model")
...
### Session Model in Discord[​](<#session-model-in-discord> "Direct link to Session Model in Discord")
By default:
...
### Interrupts and Concurrency[​](<#interrupts-and-concurrency> "Direct link to Interrupts and Concurrency")
...
## Step 1: Create a Discord Application[​](<#step-1-create-a-discord-application> "Direct link to Step 1: Create a Discord Application")
...
## Step 2: Create the Bot[​](<#step-2-create-the-bot> "Direct link to Step 2: Create the Bot")
...
## Step 3: Enable Privileged Gateway Intents[​](<#step-3-enable-privileged-gateway-intents> "Direct link to Step 3: Enable Privileged Gateway Intents")
...
## Step 4: Get the Bot Token[​](<#step-4-get-the-bot-token> "Direct link to Step 4: Get the Bot Token")
...
## Step 5: Generate the Invite URL[​](<#step-5-generate-the-invite-url> "Direct link to Step 5: Generate the Invite URL")
You need an OAuth2 URL to invite the bot to your server. There are two ways to do this:
### Option A: Using the Installation Tab (Recommended)[​](<#option-a-using-the-installation-tab-recommended> "Direct link to Option A: Using the Installation Tab \(Recommended\)")
Requires Public Bot
...
### Option B: Manual URL[​](<#option-b-manual-url> "Direct link to Option B: Manual URL")
...
### Recommended Additional Permissions[​](<#recommended-additional-permissions> "Direct link to Recommended Additional Permissions")
  * **Send Messages in Threads** — respond in thread conversations
  * **Add Reactions** — react to messages for acknowledgment


### Permission Integers[​](<#permission-integers> "Direct link to Permission Integers")
...
## Step 6: Invite to Your Server[​](<#step-6-invite-to-your-server> "Direct link to Step 6: Invite to Your Server")
...
## Step 7: Find Your Discord User ID[​](<#step-7-find-your-discord-user-id> "Direct link to Step 7: Find Your Discord User ID")
...
## Step 8: Configure Hermes Agent[​](<#step-8-configure-hermes-agent> "Direct link to Step 8: Configure Hermes Agent")
...
### Environment Variables (`.env`)[​](<#environment-variables-env> "Direct link to environment-variables-env")
...
### Config File (`config.yaml`)[​](<#config-file-configyaml> "Direct link to config-file-configyaml")
...
[/code]
#### `discord.require_mention`[​](<#discordrequire_mention> "Direct link to discordrequire_mention")
...
#### `discord.free_response_channels`[​](<#discordfree_response_channels> "Direct link to discordfree_response_channels")
...
#### `discord.auto_thread`[​](<#discordauto_thread> "Direct link to discordauto_thread")
**Type:** boolean — **Default:** `true`
...
#### `discord.reactions`[​](<#discordreactions> "Direct link to discordreactions")
**Type:** boolean — **Default:** `true`
...
#### `discord.ignored_channels`[​](<#discordignored_channels> "Direct link to discordignored_channels")
**Type:** string or list — **Default:** `[]`
...
#### `discord.no_thread_channels`[​](<#discordno_thread_channels> "Direct link to discordno_thread_channels")
**Type:** string or list — **Default:** `[]`
...
#### `discord.channel_prompts`[​](<#discordchannel_prompts> "Direct link to discordchannel_prompts")
...
#### `group_sessions_per_user`[​](<#group_sessions_per_user> "Direct link to group_sessions_per_user")
**Type:** boolean — **Default:** `true`
...
#### `display.tool_progress`[​](<#displaytool_progress> "Direct link to displaytool_progress")
...
#### `display.tool_progress_command`[​](<#displaytool_progress_command> "Direct link to displaytool_progress_command")
...
## Native Slash Commands for Skills[​](<#native-slash-commands-for-skills> "Direct link to Native Slash Commands for Skills")
...
### Disabling Slash Command Registration[​](<#disabling-slash-command-registration> "Direct link to Disabling Slash Command Registration")
...
## Sending Media (`send_message` \+ `MEDIA:` tags)[​](<#sending-media-send_message--media-tags> "Direct link to sending-media-send_message--media-tags")
...
## Forum Channels[​](<#forum-channels> "Direct link to Forum Channels")
...
### Bot is online but not responding to messages[​](<#bot-is-online-but-not-responding-to-messages> "Direct link to Bot is online but not responding to messages")
...
### "Disallowed Intents" error on startup[​](<#disallowed-intents-error-on-startup> "Direct link to "Disallowed Intents" error on startup")
...
### Bot can't see messages in a specific channel[​](<#bot-cant-see-messages-in-a-specific-channel> "Direct link to Bot can't see messages in a specific channel")
...
### 403 Forbidden errors[​](<#403-forbidden-errors> "Direct link to 403 Forbidden errors")
...
### People in the same channel are sharing context unexpectedly[​](<#people-in-the-same-channel-are-sharing-context-unexpectedly> "Direct link to People in the same channel are sharing context unexpectedly")
...
### Mention Control[​](<#mention-control> "Direct link to Mention Control")
...
For more information on securing your Hermes Agent deployment, see the [Security Guide](</docs/user-guide/security>).
  ...
  * [Native Slash Commands for Skills](<#native-slash-commands-for-skills>)
    * [Disabling Slash Command Registration](<#disabling-slash-command-registration>)
  * [Sending Media (`send_message` \+ `MEDIA:` tags)](<#sending-media-send_message--media-tags>)
