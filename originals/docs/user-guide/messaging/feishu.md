...
## Step 1: Create a Feishu / Lark App[​](<#step-1-create-a-feishu--lark-app> "Direct link to Step 1: Create a Feishu / Lark App")
### Recommended: Scan-to-Create (one command)[​](<#recommended-scan-to-create-one-command> "Direct link to Recommended: Scan-to-Create \(one command\)")
[code] 
...
### Alternative: Manual Setup[​](<#alternative-manual-setup> "Direct link to Alternative: Manual Setup")
...
## Step 2: Choose a Connection Mode[​](<#step-2-choose-a-connection-mode> "Direct link to Step 2: Choose a Connection Mode")
### Recommended: WebSocket mode[​](<#recommended-websocket-mode> "Direct link to Recommended: WebSocket mode")
...
### Optional: Webhook mode[​](<#optional-webhook-mode> "Direct link to Optional: Webhook mode")
...
### Option A: Interactive Setup[​](<#option-a-interactive-setup> "Direct link to Option A: Interactive Setup")
[code] 
    hermes gateway setup  
...
## Home Chat[​](<#home-chat> "Direct link to Home Chat")
...
### User Allowlist[​](<#user-allowlist> "Direct link to User Allowlist")
...
### Webhook Encryption Key[​](<#webhook-encryption-key> "Direct link to Webhook Encryption Key")
...
### Verification Token[​](<#verification-token> "Direct link to Verification Token")
...
## Group Message Policy[​](<#group-message-policy> "Direct link to Group Message Policy")
...
### Bot Identity[​](<#bot-identity> "Direct link to Bot Identity")
...
[/code]
## Bot-to-Bot Messaging[​](<#bot-to-bot-messaging> "Direct link to Bot-to-Bot Messaging")
...
## Interactive Card Actions[​](<#interactive-card-actions> "Direct link to Interactive Card Actions")
...
### Required Feishu App Configuration[​](<#required-feishu-app-configuration> "Direct link to Required Feishu App Configuration")
...
## Document Comment Intelligent Reply[​](<#document-comment-intelligent-reply> "Direct link to Document Comment Intelligent Reply")
...
### 3-Tier Access Control[​](<#3-tier-access-control> "Direct link to 3-Tier Access Control")
...
[/code]
### Required Feishu App Configuration[​](<#required-feishu-app-configuration-1> "Direct link to Required Feishu App Configuration")
...
## Media Support[​](<#media-support> "Direct link to Media Support")
### Inbound (receiving)[​](<#inbound-receiving> "Direct link to Inbound \(receiving\)")
...
### Outbound (sending)[​](<#outbound-sending> "Direct link to Outbound \(sending\)")
...
## Markdown Rendering and Post Fallback[​](<#markdown-rendering-and-post-fallback> "Direct link to Markdown Rendering and Post Fallback")
...
## Processing Status Reactions[​](<#processing-status-reactions> "Direct link to Processing Status Reactions")
...
## Burst Protection and Batching[​](<#burst-protection-and-batching> "Direct link to Burst Protection and Batching")
The adapter includes debouncing for rapid message bursts to avoid overwhelming the agent:
### Text Batching[​](<#text-batching> "Direct link to Text Batching")
...
### Media Batching[​](<#media-batching> "Direct link to Media Batching")
...
### Per-Chat Serialization[​](<#per-chat-serialization> "Direct link to Per-Chat Serialization")
...
## Rate Limiting (Webhook Mode)[​](<#rate-limiting-webhook-mode> "Direct link to Rate Limiting \(Webhook Mode\)")
...
### Webhook Anomaly Tracking[​](<#webhook-anomaly-tracking> "Direct link to Webhook Anomaly Tracking")
...
## WebSocket Tuning[​](<#websocket-tuning> "Direct link to WebSocket Tuning")
...
## Per-Group Access Control[​](<#per-group-access-control> "Direct link to Per-Group Access Control")
...
## All Environment Variables[​](<#all-environment-variables> "Direct link to All Environment Variables")
...
## Toolset[​](<#toolset> "Direct link to Toolset")
Feishu / Lark uses the `hermes-feishu` platform preset, which includes the same core tools as Telegram and other gateway-based messaging platforms.
  ...
  * [Bot-to-Bot Messaging](<#bot-to-bot-messaging>)
