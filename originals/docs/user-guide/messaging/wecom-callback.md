...
Hermes supports two WeCom integration modes:
  * **[WeCom Bot](</docs/user-guide/messaging/wecom>)** — bot-style, connects via WebSocket. Simpler setup, works in group chats.
...
### 1\. Create a Self-Built App in WeCom[​](<#1-create-a-self-built-app-in-wecom> "Direct link to 1. Create a Self-Built App in WeCom")
...
## Multi-App Routing[​](<#multi-app-routing> "Direct link to Multi-App Routing")
...
## Limitations[​](<#limitations> "Direct link to Limitations")
  ...
  * [Setup](<#setup>)
    * [1\. Create a Self-Built App in WeCom](<#1-create-a-self-built-app-in-wecom>)
