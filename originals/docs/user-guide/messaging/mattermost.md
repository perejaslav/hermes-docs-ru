...
### Session Model in Mattermost[​](<#session-model-in-mattermost> "Direct link to Session Model in Mattermost")
By default:
...
## Step 1: Enable Bot Accounts[​](<#step-1-enable-bot-accounts> "Direct link to Step 1: Enable Bot Accounts")
...
## Step 2: Create a Bot Account[​](<#step-2-create-a-bot-account> "Direct link to Step 2: Create a Bot Account")
...
## Step 3: Add the Bot to Channels[​](<#step-3-add-the-bot-to-channels> "Direct link to Step 3: Add the Bot to Channels")
...
## Step 4: Find Your Mattermost User ID[​](<#step-4-find-your-mattermost-user-id> "Direct link to Step 4: Find Your Mattermost User ID")
...
## Step 5: Configure Hermes Agent[​](<#step-5-configure-hermes-agent> "Direct link to Step 5: Configure Hermes Agent")
...
## Reply Mode[​](<#reply-mode> "Direct link to Reply Mode")
...
[/code]
## Mention Behavior[​](<#mention-behavior> "Direct link to Mention Behavior")
...
### WebSocket disconnects / reconnection loops[​](<#websocket-disconnects--reconnection-loops> "Direct link to WebSocket disconnects / reconnection loops")
...
[/code]
### "Failed to authenticate" on startup[​](<#failed-to-authenticate-on-startup> "Direct link to "Failed to authenticate" on startup")
