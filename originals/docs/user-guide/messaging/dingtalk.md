...
### Session Model in DingTalk[​](<#session-model-in-dingtalk> "Direct link to Session Model in DingTalk")
By default:
...
## Step 1: Create a DingTalk App[​](<#step-1-create-a-dingtalk-app> "Direct link to Step 1: Create a DingTalk App")
...
## Step 2: Enable the Robot Capability[​](<#step-2-enable-the-robot-capability> "Direct link to Step 2: Enable the Robot Capability")
...
## Step 3: Find Your DingTalk User ID[​](<#step-3-find-your-dingtalk-user-id> "Direct link to Step 3: Find Your DingTalk User ID")
...
### AI Cards[​](<#ai-cards> "Direct link to AI Cards")
...
### "dingtalk-stream not installed" error[​](<#dingtalk-stream-not-installed-error> "Direct link to "dingtalk-stream not installed" error")
...
[/code]
### "DINGTALK_CLIENT_ID and DINGTALK_CLIENT_SECRET required"[​](<#dingtalk_client_id-and-dingtalk_client_secret-required> "Direct link to "DINGTALK_CLIENT_ID and DINGTALK_CLIENT_SECRET required"")
...
### Stream disconnects / reconnection loops[​](<#stream-disconnects--reconnection-loops> "Direct link to Stream disconnects / reconnection loops")
...
### "No session_webhook available"[​](<#no-session_webhook-available> "Direct link to "No session_webhook available"")
