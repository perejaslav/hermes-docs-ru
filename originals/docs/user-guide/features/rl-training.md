...
### 1\. Discover Environments[​](<#1-discover-environments> "Direct link to 1. Discover Environments")
[code] 
...
### 2\. Select and Configure[​](<#2-select-and-configure> "Direct link to 2. Select and Configure")
[code] 
...
### 3\. Start Training[​](<#3-start-training> "Direct link to 3. Start Training")
[code] 
...
### 4\. Monitor Progress[​](<#4-monitor-progress> "Direct link to 4. Monitor Progress")
[code] 
...
### 5\. Stop or Get Results[​](<#5-stop-or-get-results> "Direct link to 5. Stop or Get Results")
[code] 
...
## Inference Testing[​](<#inference-testing> "Direct link to Inference Testing")
...
## Tinker API Integration[​](<#tinker-api-integration> "Direct link to Tinker API Integration")
...
## Creating Custom Environments[​](<#creating-custom-environments> "Direct link to Creating Custom Environments")
...
## WandB Metrics[​](<#wandb-metrics> "Direct link to WandB Metrics")
...
These are invaluable for debugging when training fails or produces unexpected results.
  ...
  * [Workflow](<#workflow>)
    * [1\. Discover Environments](<#1-discover-environments>)
    * [2\. Select and Configure](<#2-select-and-configure>)
    * [3\. Start Training](<#3-start-training>)
    * [4\. Monitor Progress](<#4-monitor-progress>)
    * [5\. Stop or Get Results](<#5-stop-or-get-results>)
  * [Inference Testing](<#inference-testing>)
  * [Tinker API Integration](<#tinker-api-integration>)
