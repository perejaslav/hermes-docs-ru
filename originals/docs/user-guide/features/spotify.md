...
### One-shot: `hermes tools`[​](<#one-shot-hermes-tools> "Direct link to one-shot-hermes-tools")
...
### Two-step flow[​](<#two-step-flow> "Direct link to Two-step flow")
#### 1\. Enable the toolset[​](<#1-enable-the-toolset> "Direct link to 1. Enable the toolset")
[code] 
    hermes tools  
...
#### 2\. Run the login wizard[​](<#2-run-the-login-wizard> "Direct link to 2. Run the login wizard")
[code] 
    hermes auth spotify  
...
### Creating the Spotify app (what the wizard asks for)[​](<#creating-the-spotify-app-what-the-wizard-asks-for> "Direct link to Creating the Spotify app \(what the wizard asks for\)")
...
### Running over SSH / in a headless environment[​](<#running-over-ssh--in-a-headless-environment> "Direct link to Running over SSH / in a headless environment")
...
## Using it[​](<#using-it> "Direct link to Using it")
...
[/code]
### Tool reference[​](<#tool-reference> "Direct link to Tool reference")
...
### Feature matrix: Free vs Premium[​](<#feature-matrix-free-vs-premium> "Direct link to Feature matrix: Free vs Premium")
...
`spotify_albums` (all)|   
`spotify_library` (all)|   
## Scheduling: Spotify + cron[​](<#scheduling-spotify--cron> "Direct link to Scheduling: Spotify + cron")
...
### Morning wake-up playlist[​](<#morning-wake-up-playlist> "Direct link to Morning wake-up playlist")
[code] 
    hermes cron add \  
...
### Wind-down at night[​](<#wind-down-at-night> "Direct link to Wind-down at night")
[code] 
    hermes cron add \  
      --name "wind-down" \  
      "30 22 * * *" \  
...
Full cron reference: [Cron Jobs](</docs/user-guide/features/cron>).
...
## Advanced: custom scopes[​](<#advanced-custom-scopes> "Direct link to Advanced: custom scopes")
...
## Advanced: custom client ID / redirect URI[​](<#advanced-custom-client-id--redirect-uri> "Direct link to Advanced: custom client ID / redirect URI")
[code] 
...
## Where things live[​](<#where-things-live> "Direct link to Where things live")
File| Contents  
---|---  
...
Spotify app| owned by you at [developer.spotify.com/dashboard](<https://developer.spotify.com/dashboard>); contains the Client ID and the redirect URI allow-list  
  ...
  * [Setup](<#setup>)
    * [One-shot: `hermes tools`](<#one-shot-hermes-tools>)
    * [Two-step flow](<#two-step-flow>)
    * [Creating the Spotify app (what the wizard asks for)](<#creating-the-spotify-app-what-the-wizard-asks-for>)
    * [Running over SSH / in a headless environment](<#running-over-ssh--in-a-headless-environment>)
  * [Verify](<#verify>)
  * [Using it](<#using-it>)
    * [Tool reference](<#tool-reference>)
    * [Feature matrix: Free vs Premium](<#feature-matrix-free-vs-premium>)
  * [Scheduling: Spotify + cron](<#scheduling-spotify--cron>)
    * [Morning wake-up playlist](<#morning-wake-up-playlist>)
    * [Wind-down at night](<#wind-down-at-night>)
    * [Gotchas](<#gotchas>)
  * [Sign out](<#sign-out>)
  * [Troubleshooting](<#troubleshooting>)
  * [Advanced: custom scopes](<#advanced-custom-scopes>)
  * [Advanced: custom client ID / redirect URI](<#advanced-custom-client-id--redirect-uri>)
