...
Throughout the tutorial, **code blocks labelled`bash` are commands _you_ run.** Code blocks labelled `# worker tool calls` are what the spawned worker's model emits as tool calls — shown here so you can see the loop end-to-end, not because you'd ever run them yourself.
## The board at a glance[​](<#the-board-at-a-glance> "Direct link to The board at a glance")
...
### Flat view[​](<#flat-view> "Direct link to Flat view")
...
## Story 1 — Solo dev shipping a feature[​](<#story-1--solo-dev-shipping-a-feature> "Direct link to Story 1 — Solo dev shipping a feature")
...
[/code]
## Story 2 — Fleet farming[​](<#story-2--fleet-farming> "Direct link to Story 2 — Fleet farming")
...
## Story 3 — Role pipeline with retry[​](<#story-3--role-pipeline-with-retry> "Direct link to Story 3 — Role pipeline with retry")
...
## Story 4 — Circuit breaker and crash recovery[​](<#story-4--circuit-breaker-and-crash-recovery> "Direct link to Story 4 — Circuit breaker and crash recovery")
...
### Circuit breaker — permanent-looking failure[​](<#circuit-breaker--permanent-looking-failure> "Direct link to Circuit breaker — permanent-looking failure")
...
### Crash recovery — worker dies mid-flight[​](<#crash-recovery--worker-dies-mid-flight> "Direct link to Crash recovery — worker dies mid-flight")
...
## Structured handoff — why `summary` and `metadata` matter[​](<#structured-handoff--why-summary-and-metadata-matter> "Direct link to structured-handoff--why-summary-and-metadata-matter")
...
## Inspecting a task currently running[​](<#inspecting-a-task-currently-running> "Direct link to Inspecting a task currently running")
...
## Next steps[​](<#next-steps> "Direct link to Next steps")
  ...
  * [The board at a glance](<#the-board-at-a-glance>)
    * [Flat view](<#flat-view>)
  * [Story 1 — Solo dev shipping a feature](<#story-1--solo-dev-shipping-a-feature>)
  * [Story 2 — Fleet farming](<#story-2--fleet-farming>)
  * [Story 3 — Role pipeline with retry](<#story-3--role-pipeline-with-retry>)
  * [Story 4 — Circuit breaker and crash recovery](<#story-4--circuit-breaker-and-crash-recovery>)
    * [Circuit breaker — permanent-looking failure](<#circuit-breaker--permanent-looking-failure>)
    * [Crash recovery — worker dies mid-flight](<#crash-recovery--worker-dies-mid-flight>)
  * [Structured handoff — why `summary` and `metadata` matter](<#structured-handoff--why-summary-and-metadata-matter>)
  * [Inspecting a task currently running](<#inspecting-a-task-currently-running>)
