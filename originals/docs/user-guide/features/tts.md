...
### Input length limits[​](<#input-length-limits> "Direct link to Input length limits")
...
### xAI Custom Voices (voice cloning)[​](<#xai-custom-voices-voice-cloning> "Direct link to xAI Custom Voices \(voice cloning\)")
...
### Piper (local, 44 languages)[​](<#piper-local-44-languages> "Direct link to Piper \(local, 44 languages\)")
...
### Custom command providers[​](<#custom-command-providers> "Direct link to Custom command providers")
...
[/code]
#### Example: Doubao (Chinese seed-tts-2.0)[​](<#example-doubao-chinese-seed-tts-20> "Direct link to Example: Doubao \(Chinese seed-tts-2.0\)")
...
#### Optional keys[​](<#optional-keys> "Direct link to Optional keys")
Key| Default| Meaning  
---|---|---  
...
#### Example: Doubao / Volcengine ASR[​](<#example-doubao--volcengine-asr> "Direct link to Example: Doubao / Volcengine ASR")
...
If your configured provider isn't available, Hermes automatically falls back:
  ...
  * [Text-to-Speech](<#text-to-speech>)
    ...
    * [Telegram Voice Bubbles & ffmpeg](<#telegram-voice-bubbles--ffmpeg>)
    * [xAI Custom Voices (voice cloning)](<#xai-custom-voices-voice-cloning>)
    * [Piper (local, 44 languages)](<#piper-local-44-languages>)
    * [Custom command providers](<#custom-command-providers>)
