...
## Enabling the Tool Gateway[​](<#enabling-the-tool-gateway> "Direct link to Enabling the Tool Gateway")
### During model setup[​](<#during-model-setup> "Direct link to During model setup")
...
### Via `hermes tools`[​](<#via-hermes-tools> "Direct link to via-hermes-tools")
...
## Switching Back to Direct Keys[​](<#switching-back-to-direct-keys> "Direct link to Switching Back to Direct Keys")
...
## Advanced: Self-Hosted Gateway[​](<#advanced-self-hosted-gateway> "Direct link to Advanced: Self-Hosted Gateway")
...
### Do I need to delete my existing API keys?[​](<#do-i-need-to-delete-my-existing-api-keys> "Direct link to Do I need to delete my existing API keys?")
...
### Can I use the gateway for some tools and direct keys for others?[​](<#can-i-use-the-gateway-for-some-tools-and-direct-keys-for-others> "Direct link to Can I use the gateway for some tools and direct keys for others?")
...
### What if my subscription expires?[​](<#what-if-my-subscription-expires> "Direct link to What if my subscription expires?")
...
### Does the gateway work with the messaging gateway?[​](<#does-the-gateway-work-with-the-messaging-gateway> "Direct link to Does the gateway work with the messaging gateway?")
...
### Is Modal included?[​](<#is-modal-included> "Direct link to Is Modal included?")
Modal (serverless terminal backend) is available as an optional add-on through the Nous subscription. It's not enabled by the Tool Gateway prompt — configure it separately via `hermes setup terminal` or in `config.yaml`.
  ...
  * [Enabling the Tool Gateway](<#enabling-the-tool-gateway>)
    * [During model setup](<#during-model-setup>)
    * [Via `hermes tools`](<#via-hermes-tools>)
    * [Manual configuration](<#manual-configuration>)
  * [How It Works](<#how-it-works>)
    * [Precedence](<#precedence>)
  * [Switching Back to Direct Keys](<#switching-back-to-direct-keys>)
  * [Checking Status](<#checking-status>)
  * [Advanced: Self-Hosted Gateway](<#advanced-self-hosted-gateway>)
  * [FAQ](<#faq>)
    * [Do I need to delete my existing API keys?](<#do-i-need-to-delete-my-existing-api-keys>)
    * [Can I use the gateway for some tools and direct keys for others?](<#can-i-use-the-gateway-for-some-tools-and-direct-keys-for-others>)
    * [What if my subscription expires?](<#what-if-my-subscription-expires>)
    * [Does the gateway work with the messaging gateway?](<#does-the-gateway-work-with-the-messaging-gateway>)
    * [Is Modal included?](<#is-modal-included>)
