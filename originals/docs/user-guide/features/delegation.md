...
## Single Task[​](<#single-task> "Direct link to Single Task")
[code] 
    delegate_task(  
...
[/code]
## Parallel Batch[​](<#parallel-batch> "Direct link to Parallel Batch")
...
[/code]
## How Subagent Context Works[​](<#how-subagent-context-works> "Direct link to How Subagent Context Works")
...
### Parallel Research[​](<#parallel-research> "Direct link to Parallel Research")
...
[/code]
### Code Review + Fix[​](<#code-review--fix> "Direct link to Code Review + Fix")
...
[/code]
### Multi-File Refactoring[​](<#multi-file-refactoring> "Direct link to Multi-File Refactoring")
...
[/code]
## Batch Mode Details[​](<#batch-mode-details> "Direct link to Batch Mode Details")
...
## Model Override[​](<#model-override> "Direct link to Model Override")
...
## Toolset Selection Tips[​](<#toolset-selection-tips> "Direct link to Toolset Selection Tips")
...
## Max Iterations[​](<#max-iterations> "Direct link to Max Iterations")
...
[/code]
## Child Timeout[​](<#child-timeout> "Direct link to Child Timeout")
...
## Monitoring Running Subagents (`/agents`)[​](<#monitoring-running-subagents-agents> "Direct link to monitoring-running-subagents-agents")
...
## Depth Limit and Nested Orchestration[​](<#depth-limit-and-nested-orchestration> "Direct link to Depth Limit and Nested Orchestration")
...
For multi-stage workflows (research → synthesis, or parallel orchestration over sub-problems), a parent can spawn **orchestrator** children that _can_ delegate their own workers:
[code] 
    delegate_task(  
...
## Lifetime and Durability[​](<#lifetime-and-durability> "Direct link to Lifetime and Durability")
...
## Delegation vs execute_code[​](<#delegation-vs-execute_code> "Direct link to Delegation vs execute_code")
...
The agent handles delegation automatically based on the task complexity. You don't need to explicitly ask it to delegate — it will do so when it makes sense.
  ...
  * [How Subagent Context Works](<#how-subagent-context-works>)
  * [Practical Examples](<#practical-examples>)
    * [Parallel Research](<#parallel-research>)
    * [Code Review + Fix](<#code-review--fix>)
    * [Multi-File Refactoring](<#multi-file-refactoring>)
  * [Batch Mode Details](<#batch-mode-details>)
  * [Model Override](<#model-override>)
  * [Toolset Selection Tips](<#toolset-selection-tips>)
  * [Max Iterations](<#max-iterations>)
  * [Child Timeout](<#child-timeout>)
  * [Monitoring Running Subagents (`/agents`)](<#monitoring-running-subagents-agents>)
  * [Depth Limit and Nested Orchestration](<#depth-limit-and-nested-orchestration>)
  * [Lifetime and Durability](<#lifetime-and-durability>)
