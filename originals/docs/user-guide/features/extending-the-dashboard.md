...
If you just want to use the dashboard, see [Web Dashboard](</docs/user-guide/features/web-dashboard>). If you want to reskin the terminal CLI (not the web dashboard), see [Skins & Themes](</docs/user-guide/features/skins>) — the CLI skin system is unrelated to dashboard themes.
...
### Quick start — your first theme[​](<#quick-start--your-first-theme> "Direct link to Quick start — your first theme")
[code] 
...
### Palette, typography, layout[​](<#palette-typography-layout> "Direct link to Palette, typography, layout")
These three blocks are the heart of a theme. Each is independent — override one, leave the others.
#### Palette (3-layer)[​](<#palette-3-layer> "Direct link to Palette \(3-layer\)")
...
### Theme assets (images as CSS vars)[​](<#theme-assets-images-as-css-vars> "Direct link to Theme assets \(images as CSS vars\)")
...
### Color overrides[​](<#color-overrides> "Direct link to Color overrides")
...
### Raw `customCSS`[​](<#raw-customcss> "Direct link to raw-customcss")
...
### Full theme YAML reference[​](<#full-theme-yaml-reference> "Direct link to Full theme YAML reference")
...
### Quick start — your first plugin[​](<#quick-start--your-first-plugin> "Direct link to Quick start — your first plugin")
...
A single plugin directory can carry three orthogonal extensions:
  * `plugin.yaml` \+ `__init__.py` — CLI/gateway plugin ([see plugins page](</docs/user-guide/features/plugins>)).
...
### The Plugin SDK[​](<#the-plugin-sdk> "Direct link to The Plugin SDK")
...
[/code]
#### Calling your plugin's backend[​](<#calling-your-plugins-backend> "Direct link to Calling your plugin's backend")
[code] 
...
#### Calling built-in Hermes endpoints[​](<#calling-built-in-hermes-endpoints> "Direct link to Calling built-in Hermes endpoints")
[code] 
    // Agent status  
...
[/code]
See [Web Dashboard → REST API](</docs/user-guide/features/web-dashboard#rest-api>) for the full list.
...
[/code]
#### Slot catalogue[​](<#slot-catalogue> "Direct link to Slot catalogue")
...
#### Re-registration and HMR[​](<#re-registration-and-hmr> "Direct link to Re-registration and HMR")
...
### Replacing built-in pages (`tab.override`)[​](<#replacing-built-in-pages-taboverride> "Direct link to replacing-built-in-pages-taboverride")
...
### Augmenting built-in pages (page-scoped slots)[​](<#augmenting-built-in-pages-page-scoped-slots> "Direct link to Augmenting built-in pages \(page-scoped slots\)")
...
### Slot-only plugins (`tab.hidden`)[​](<#slot-only-plugins-tabhidden> "Direct link to slot-only-plugins-tabhidden")
...
[/code]
### Custom CSS per plugin[​](<#custom-css-per-plugin> "Direct link to Custom CSS per plugin")
...
### Plugin discovery & reload[​](<#plugin-discovery--reload> "Direct link to Plugin discovery & reload")
...
#### Plugin load lifecycle[​](<#plugin-load-lifecycle> "Direct link to Plugin load lifecycle")
...
* * *
## Combined theme + plugin demo[​](<#combined-theme--plugin-demo> "Direct link to Combined theme + plugin demo")
...
### Theme endpoints[​](<#theme-endpoints> "Direct link to Theme endpoints")
...
### Plugin endpoints[​](<#plugin-endpoints> "Direct link to Plugin endpoints")
Endpoint| Method| Description  
---|---|---  
...
### SDK on `window`[​](<#sdk-on-window> "Direct link to sdk-on-window")
