...
## How it runs[​](<#how-it-runs> "Direct link to How it runs")
...
### Running the review on a cheaper aux model[​](<#running-the-review-on-a-cheaper-aux-model> "Direct link to Running the review on a cheaper aux model")
...
[/code]
## Backups and rollback[​](<#backups-and-rollback> "Direct link to Backups and rollback")
...
## What "agent-created" means[​](<#what-agent-created-means> "Direct link to What "agent-created" means")
...
## Pinning a skill[​](<#pinning-a-skill> "Direct link to Pinning a skill")
...
## Usage telemetry[​](<#usage-telemetry> "Direct link to Usage telemetry")
...
## Per-run reports[​](<#per-run-reports> "Direct link to Per-run reports")
...
## Restoring an archived skill[​](<#restoring-an-archived-skill> "Direct link to Restoring an archived skill")
...
## Disabling per environment[​](<#disabling-per-environment> "Direct link to Disabling per environment")
...
## See also[​](<#see-also> "Direct link to See also")
  ...
  * [Configuration](<#configuration>)
    * [Running the review on a cheaper aux model](<#running-the-review-on-a-cheaper-aux-model>)
  * [CLI](<#cli>)
  * [Backups and rollback](<#backups-and-rollback>)
  * [What "agent-created" means](<#what-agent-created-means>)
  * [Pinning a skill](<#pinning-a-skill>)
  * [Usage telemetry](<#usage-telemetry>)
  * [Per-run reports](<#per-run-reports>)
  * [Restoring an archived skill](<#restoring-an-archived-skill>)
  * [Disabling per environment](<#disabling-per-environment>)
  * [See also](<#see-also>)
