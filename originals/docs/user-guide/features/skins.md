...
## Change skins[​](<#change-skins> "Direct link to Change skins")
[code] 
...
[/code]
## Built-in skins[​](<#built-in-skins> "Direct link to Built-in skins")
...
## Complete list of configurable keys[​](<#complete-list-of-configurable-keys> "Direct link to Complete list of configurable keys")
### Colors (`colors:`)[​](<#colors-colors> "Direct link to colors-colors")
...
### Spinner (`spinner:`)[​](<#spinner-spinner> "Direct link to spinner-spinner")
...
### Branding (`branding:`)[​](<#branding-branding> "Direct link to branding-branding")
...
### Other top-level keys[​](<#other-top-level-keys> "Direct link to Other top-level keys")
...
## Custom skins[​](<#custom-skins> "Direct link to Custom skins")
...
### Full custom skin YAML template[​](<#full-custom-skin-yaml-template> "Direct link to Full custom skin YAML template")
[code] 
...
[/code]
### Minimal custom skin example[​](<#minimal-custom-skin-example> "Direct link to Minimal custom skin example")
...
[/code]
## Hermes Mod — Visual Skin Editor[​](<#hermes-mod--visual-skin-editor> "Direct link to Hermes Mod — Visual Skin Editor")
