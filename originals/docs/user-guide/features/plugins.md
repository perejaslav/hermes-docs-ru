...
### Plugin sub-categories[​](<#plugin-sub-categories> "Direct link to Plugin sub-categories")
...
## Plugins are opt-in (with a few exceptions)[​](<#plugins-are-opt-in-with-a-few-exceptions> "Direct link to Plugins are opt-in \(with a few exceptions\)")
...
### What the allow-list does NOT gate[​](<#what-the-allow-list-does-not-gate> "Direct link to What the allow-list does NOT gate")
...
## Pluggable interfaces — where to go for each[​](<#pluggable-interfaces--where-to-go-for-each> "Direct link to Pluggable interfaces — where to go for each")
...
## NixOS declarative plugins[​](<#nixos-declarative-plugins> "Direct link to NixOS declarative plugins")
