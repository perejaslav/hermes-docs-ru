...
## When the Agent Uses This[​](<#when-the-agent-uses-this> "Direct link to When the Agent Uses This")
...
[/code]
### Multi-Step Web Research[​](<#multi-step-web-research> "Direct link to Multi-Step Web Research")
[code] 
    from hermes_tools import web_search, web_extract  
    import json  
...
[/code]
### Bulk File Refactoring[​](<#bulk-file-refactoring> "Direct link to Bulk File Refactoring")
[code] 
...
[/code]
### Build and Test Pipeline[​](<#build-and-test-pipeline> "Direct link to Build and Test Pipeline")
[code] 
...
[/code]
## Execution Mode[​](<#execution-mode> "Direct link to Execution Mode")
...
[/code]
## How Tool Calls Work Inside Scripts[​](<#how-tool-calls-work-inside-scripts> "Direct link to How Tool Calls Work Inside Scripts")
...
### Skill Environment Variable Passthrough[​](<#skill-environment-variable-passthrough> "Direct link to Skill Environment Variable Passthrough")
...
## execute_code vs terminal[​](<#execute_code-vs-terminal> "Direct link to execute_code vs terminal")
...
Code execution requires Unix domain sockets and is available on **Linux and macOS only**. It is automatically disabled on Windows — the agent falls back to regular sequential tool calls.
  ...
  * [When the Agent Uses This](<#when-the-agent-uses-this>)
  * [Practical Examples](<#practical-examples>)
    * [Data Processing Pipeline](<#data-processing-pipeline>)
    * [Multi-Step Web Research](<#multi-step-web-research>)
    * [Bulk File Refactoring](<#bulk-file-refactoring>)
    * [Build and Test Pipeline](<#build-and-test-pipeline>)
  * [Execution Mode](<#execution-mode>)
  * [Resource Limits](<#resource-limits>)
  * [How Tool Calls Work Inside Scripts](<#how-tool-calls-work-inside-scripts>)
  * [Error Handling](<#error-handling>)
  * [Security](<#security>)
    * [Skill Environment Variable Passthrough](<#skill-environment-variable-passthrough>)
