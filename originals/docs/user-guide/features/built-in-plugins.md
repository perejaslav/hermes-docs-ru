...
`example-dashboard`| dashboard example| Reference dashboard plugin for [Extending the Dashboard](</docs/user-guide/features/extending-the-dashboard>)  
...
### observability/langfuse[​](<#observabilitylangfuse> "Direct link to observability/langfuse")
...
### google_meet[​](<#google_meet> "Direct link to google_meet")
...
### hermes-achievements[​](<#hermes-achievements> "Direct link to hermes-achievements")
