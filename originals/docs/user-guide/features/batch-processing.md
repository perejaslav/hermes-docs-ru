...
### Provider Routing (OpenRouter)[​](<#provider-routing-openrouter> "Direct link to Provider Routing \(OpenRouter\)")
...
### Reasoning Control[​](<#reasoning-control> "Direct link to Reasoning Control")
Parameter| Description  
---|---  
...
## Toolset Distributions[​](<#toolset-distributions> "Direct link to Toolset Distributions")
...
[/code]
### Trajectory Format[​](<#trajectory-format> "Direct link to Trajectory Format")
...
## Checkpointing[​](<#checkpointing> "Direct link to Checkpointing")
...
### How Resume Works[​](<#how-resume-works> "Direct link to How Resume Works")
...
## Quality Filtering[​](<#quality-filtering> "Direct link to Quality Filtering")
...
[/code]
### Per-Prompt Container Images[​](<#per-prompt-container-images> "Direct link to Per-Prompt Container Images")
...
The batch runner verifies Docker images are accessible before running each prompt.
  ...
  * [Toolset Distributions](<#toolset-distributions>)
  ...
  * [Use Cases](<#use-cases>)
    ...
    * [Per-Prompt Container Images](<#per-prompt-container-images>)
