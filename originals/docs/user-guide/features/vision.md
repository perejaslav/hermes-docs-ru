...
## Image Routing (Vision-Capable vs Text-Only Models)[​](<#image-routing-vision-capable-vs-text-only-models> "Direct link to Image Routing \(Vision-Capable vs Text-Only Models\)")
...
Which auxiliary model handles the text-description path is configurable under `auxiliary.vision` — see [Auxiliary Models](</docs/user-guide/configuration#auxiliary-models>).
  ...
  * [Paste Methods](<#paste-methods>)
    * [`/paste` Command](<#paste-command>)
    * [Ctrl+V / Cmd+V](<#ctrlv--cmdv>)
    * [`/terminal-setup` for VS Code / Cursor / Windsurf](<#terminal-setup-for-vs-code--cursor--windsurf>)
  ...
  * [Why Terminals Can't Paste Images](<#why-terminals-cant-paste-images>)
  * [Supported Models](<#supported-models>)
  * [Image Routing (Vision-Capable vs Text-Only Models)](<#image-routing-vision-capable-vs-text-only-models>)
