...
[/code]
### Hybrid routing: cloud for public URLs, local for LAN/localhost[​](<#hybrid-routing-cloud-for-public-urls-local-for-lanlocalhost> "Direct link to Hybrid routing: cloud for public URLs, local for LAN/localhost")
...
### WSL2 + Windows Chrome: prefer MCP over `/browser connect`[​](<#wsl2--windows-chrome-prefer-mcp-over-browser-connect> "Direct link to wsl2--windows-chrome-prefer-mcp-over-browser-connect")
...
## Limitations[​](<#limitations> "Direct link to Limitations")
  ...
  * [Overview](<#overview>)
  * [Setup](<#setup>)
    * [Browserbase cloud mode](<#browserbase-cloud-mode>)
    * [Browser Use cloud mode](<#browser-use-cloud-mode>)
    * [Firecrawl cloud mode](<#firecrawl-cloud-mode>)
    * [Hybrid routing: cloud for public URLs, local for LAN/localhost](<#hybrid-routing-cloud-for-public-urls-local-for-lanlocalhost>)
    * [Camofox local mode](<#camofox-local-mode>)
    * [Local Chrome via CDP (`/browser connect`)](<#local-chrome-via-cdp-browser-connect>)
    * [WSL2 + Windows Chrome: prefer MCP over `/browser connect`](<#wsl2--windows-chrome-prefer-mcp-over-browser-connect>)
    * [Local browser mode](<#local-browser-mode>)
    * [Optional Environment Variables](<#optional-environment-variables>)
    * [Install agent-browser CLI](<#install-agent-browser-cli>)
