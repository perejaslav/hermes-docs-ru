...
## How Sessions Work[​](<#how-sessions-work> "Direct link to How Sessions Work")
...
### Session Sources[​](<#session-sources> "Direct link to Session Sources")
...
## CLI Session Resume[​](<#cli-session-resume> "Direct link to CLI Session Resume")
Resume previous conversations from the CLI using `--continue` or `--resume`:
### Continue Last Session[​](<#continue-last-session> "Direct link to Continue Last Session")
[code] 
...
### Resume by Name[​](<#resume-by-name> "Direct link to Resume by Name")
...
[/code]
### Resume Specific Session[​](<#resume-specific-session> "Direct link to Resume Specific Session")
[code] 
...
### Conversation Recap on Resume[​](<#conversation-recap-on-resume> "Direct link to Conversation Recap on Resume")
...
## Session Naming[​](<#session-naming> "Direct link to Session Naming")
Give sessions human-readable titles so you can find and resume them easily.
### Auto-Generated Titles[​](<#auto-generated-titles> "Direct link to Auto-Generated Titles")
...
### Setting a Title Manually[​](<#setting-a-title-manually> "Direct link to Setting a Title Manually")
...
[/code]
### Title Rules[​](<#title-rules> "Direct link to Title Rules")
...
### Auto-Lineage on Compression[​](<#auto-lineage-on-compression> "Direct link to Auto-Lineage on Compression")
...
### /title in Messaging Platforms[​](<#title-in-messaging-platforms> "Direct link to /title in Messaging Platforms")
...
## Session Management Commands[​](<#session-management-commands> "Direct link to Session Management Commands")
...
### Delete a Session[​](<#delete-a-session> "Direct link to Delete a Session")
[code] 
...
[/code]
### Rename a Session[​](<#rename-a-session> "Direct link to Rename a Session")
[code] 
...
### Prune Old Sessions[​](<#prune-old-sessions> "Direct link to Prune Old Sessions")
[code] 
...
### Session Statistics[​](<#session-statistics> "Direct link to Session Statistics")
[code] 
...
## Session Search Tool[​](<#session-search-tool> "Direct link to Session Search Tool")
...
### FTS5 Query Syntax[​](<#fts5-query-syntax> "Direct link to FTS5 Query Syntax")
...
### When It's Used[​](<#when-its-used> "Direct link to When It's Used")
...
## Per-Platform Session Tracking[​](<#per-platform-session-tracking> "Direct link to Per-Platform Session Tracking")
### Gateway Sessions[​](<#gateway-sessions> "Direct link to Gateway Sessions")
...
### Shared vs Isolated Group Sessions[​](<#shared-vs-isolated-group-sessions> "Direct link to Shared vs Isolated Group Sessions")
...
### Session Reset Policies[​](<#session-reset-policies> "Direct link to Session Reset Policies")
...
## Storage Locations[​](<#storage-locations> "Direct link to Storage Locations")
...
## Session Expiry and Cleanup[​](<#session-expiry-and-cleanup> "Direct link to Session Expiry and Cleanup")
...
### Manual Cleanup[​](<#manual-cleanup> "Direct link to Manual Cleanup")
[code] 
