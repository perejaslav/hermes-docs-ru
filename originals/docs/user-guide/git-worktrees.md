...
## Why Use Worktrees with Hermes?[​](<#why-use-worktrees-with-hermes> "Direct link to Why Use Worktrees with Hermes?")
...
## Quick Start: Creating a Worktree[​](<#quick-start-creating-a-worktree> "Direct link to Quick Start: Creating a Worktree")
...
## Running Multiple Agents in Parallel[​](<#running-multiple-agents-in-parallel> "Direct link to Running Multiple Agents in Parallel")
...
## Cleaning Up Worktrees Safely[​](<#cleaning-up-worktrees-safely> "Direct link to Cleaning Up Worktrees Safely")
...
## Using `hermes -w` (Automatic Worktree Mode)[​](<#using-hermes--w-automatic-worktree-mode> "Direct link to using-hermes--w-automatic-worktree-mode")
...
This combination gives you:
  ...
  * [Why Use Worktrees with Hermes?](<#why-use-worktrees-with-hermes>)
  * [Quick Start: Creating a Worktree](<#quick-start-creating-a-worktree>)
  * [Running Multiple Agents in Parallel](<#running-multiple-agents-in-parallel>)
  * [Cleaning Up Worktrees Safely](<#cleaning-up-worktrees-safely>)
  * [Best Practices](<#best-practices>)
  * [Using `hermes -w` (Automatic Worktree Mode)](<#using-hermes--w-automatic-worktree-mode>)
