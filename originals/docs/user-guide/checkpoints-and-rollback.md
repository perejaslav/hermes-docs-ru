...
## What Triggers a Checkpoint[​](<#what-triggers-a-checkpoint> "Direct link to What Triggers a Checkpoint")
...
## How Checkpoints Work[​](<#how-checkpoints-work> "Direct link to How Checkpoints Work")
At a high level:
...
## Listing Checkpoints[​](<#listing-checkpoints> "Direct link to Listing Checkpoints")
From a CLI session:
[code] 
    /rollback  
...
[/code]
## Inspecting the Store from the Shell[​](<#inspecting-the-store-from-the-shell> "Direct link to Inspecting the Store from the Shell")
[code] 
    hermes checkpoints  
...
[/code]
## Previewing Changes with `/rollback diff`[​](<#previewing-changes-with-rollback-diff> "Direct link to previewing-changes-with-rollback-diff")
...
## Restoring with `/rollback`[​](<#restoring-with-rollback> "Direct link to restoring-with-rollback")
[code] 
    /rollback 1  
...
## Single-File Restore[​](<#single-file-restore> "Direct link to Single-File Restore")
Restore just one file from a checkpoint without affecting the rest of the directory:
[code] 
    /rollback 1 src/broken_file.py  
    
[/code]
## Safety and Performance Guards[​](<#safety-and-performance-guards> "Direct link to Safety and Performance Guards")
...
## Where Checkpoints Live[​](<#where-checkpoints-live> "Direct link to Where Checkpoints Live")
[code] 
    ~/.hermes/checkpoints/  
...
### Migration from v1[​](<#migration-from-v1> "Direct link to Migration from v1")
...
For running multiple agents in parallel on the same repo, see the guide on [Git worktrees](</docs/user-guide/git-worktrees>).
  ...
  * [Inspecting the Store from the Shell](<#inspecting-the-store-from-the-shell>)
