...
## The Models page[​](<#the-models-page> "Direct link to The Models page")
...
## Setting the main model[​](<#setting-the-main-model> "Direct link to Setting the main model")
...
## Setting auxiliary models[​](<#setting-auxiliary-models> "Direct link to Setting auxiliary models")
...
### Common override patterns[​](<#common-override-patterns> "Direct link to Common override patterns")
...
### Per-task override[​](<#per-task-override> "Direct link to Per-task override")
...
### Reset all to auto[​](<#reset-all-to-auto> "Direct link to Reset all to auto")
...
## The "Use as" shortcut[​](<#the-use-as-shortcut> "Direct link to The "Use as" shortcut")
...
## What gets written to `config.yaml`[​](<#what-gets-written-to-configyaml> "Direct link to what-gets-written-to-configyaml")
...
## When does it take effect?[​](<#when-does-it-take-effect> "Direct link to When does it take effect?")
...
### "No authenticated providers" in the picker[​](<#no-authenticated-providers-in-the-picker> "Direct link to "No authenticated providers" in the picker")
...
### Main model didn't change in my running chat[​](<#main-model-didnt-change-in-my-running-chat> "Direct link to Main model didn't change in my running chat")
...
### Auxiliary override "didn't take effect"[​](<#auxiliary-override-didnt-take-effect> "Direct link to Auxiliary override "didn't take effect"")
...
### I picked a model but Hermes switched providers on me[​](<#i-picked-a-model-but-hermes-switched-providers-on-me> "Direct link to I picked a model but Hermes switched providers on me")
...
## Alternative methods[​](<#alternative-methods> "Direct link to Alternative methods")
### CLI slash command[​](<#cli-slash-command> "Direct link to CLI slash command")
...
### Custom aliases[​](<#custom-aliases> "Direct link to Custom aliases")
...
### `hermes model` subcommand[​](<#hermes-model-subcommand> "Direct link to hermes-model-subcommand")
[code] 
    hermes model list                   # list authenticated providers + models  
    hermes model set anthropic/claude-opus-4.7 --provider openrouter  
    
[/code]
### Direct config edit[​](<#direct-config-edit> "Direct link to Direct config edit")
...
The session token is injected into the dashboard HTML at startup and rotates on every server restart. Grab it from the browser devtools (`window.__HERMES_SESSION_TOKEN__`) if you're scripting against a running dashboard.
  ...
  * [Setting the main model](<#setting-the-main-model>)
  * [Setting auxiliary models](<#setting-auxiliary-models>)
    * [Common override patterns](<#common-override-patterns>)
    * [Per-task override](<#per-task-override>)
    * [Reset all to auto](<#reset-all-to-auto>)
  * [The "Use as" shortcut](<#the-use-as-shortcut>)
  * [What gets written to `config.yaml`](<#what-gets-written-to-configyaml>)
  * [When does it take effect?](<#when-does-it-take-effect>)
  * [Troubleshooting](<#troubleshooting>)
    * ["No authenticated providers" in the picker](<#no-authenticated-providers-in-the-picker>)
    * [Main model didn't change in my running chat](<#main-model-didnt-change-in-my-running-chat>)
    * [Auxiliary override "didn't take effect"](<#auxiliary-override-didnt-take-effect>)
    * [I picked a model but Hermes switched providers on me](<#i-picked-a-model-but-hermes-switched-providers-on-me>)
  * [Alternative methods](<#alternative-methods>)
    * [CLI slash command](<#cli-slash-command>)
    * [Custom aliases](<#custom-aliases>)
    * [`hermes model` subcommand](<#hermes-model-subcommand>)
