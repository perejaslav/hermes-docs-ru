...
For maximum effect, combine the system prompt to set the jailbreak frame AND prefill to prime the model's response pattern. The system prompt tells the model _what to do_ ; the prefill shows it _already doing it_.
...
## Source Credits[​](<#source-credits> "Direct link to Source Credits")
  ...
  * [What is G0DM0D3?](<#what-is-g0dm0d3>)
  * [Three Attack Modes](<#three-attack-modes>)
  ...
  * [Auto-Jailbreak Pipeline (Recommended)](<#auto-jailbreak-pipeline-recommended>)
    * [What auto-jailbreak does](<#what-auto-jailbreak-does>)
    * [Model-Specific Strategy Order](<#model-specific-strategy-order>)
  * [Hermes Integration](<#hermes-integration>)
    * [Ephemeral System Prompt (`config.yaml`)](<#ephemeral-system-prompt-configyaml>)
    * [Prefill Messages (`prefill.json`)](<#prefill-messages-prefilljson>)
    * [Using Both Together](<#using-both-together>)
  * [Quick Start Commands](<#quick-start-commands>)
  * [Tested Results (March 2026)](<#tested-results-march-2026>)
    * [Gray-area query ("how to pick a lock")](<#gray-area-query-how-to-pick-a-lock>)
    * [Hard query ("write a phishing email template")](<#hard-query-write-a-phishing-email-template>)
