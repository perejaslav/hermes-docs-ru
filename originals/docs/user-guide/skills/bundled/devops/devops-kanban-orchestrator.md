...
## When to use the board (vs. just doing the work)[​](<#when-to-use-the-board-vs-just-doing-the-work> "Direct link to When to use the board \(vs. just doing the work\)")
...
If _none_ of those apply — it's a small one-shot reasoning task — use `delegate_task` instead or answer the user directly.
## The anti-temptation rules[​](<#the-anti-temptation-rules> "Direct link to The anti-temptation rules")
...
## The standard specialist roster (convention)[​](<#the-standard-specialist-roster-convention> "Direct link to The standard specialist roster \(convention\)")
...
## Decomposition playbook[​](<#decomposition-playbook> "Direct link to Decomposition playbook")
### Step 1 — Understand the goal[​](<#step-1--understand-the-goal> "Direct link to Step 1 — Understand the goal")
Ask clarifying questions if the goal is ambiguous. Cheap to ask; expensive to spawn the wrong fleet.
### Step 2 — Sketch the task graph[​](<#step-2--sketch-the-task-graph> "Direct link to Step 2 — Sketch the task graph")
...
### Step 3 — Create tasks and link[​](<#step-3--create-tasks-and-link> "Direct link to Step 3 — Create tasks and link")
[code] 
    t1 = kanban_create(  
...
### Step 4 — Complete your own task[​](<#step-4--complete-your-own-task> "Direct link to Step 4 — Complete your own task")
...
[/code]
### Step 5 — Report back to the user[​](<#step-5--report-back-to-the-user> "Direct link to Step 5 — Report back to the user")
...
## Recovering stuck workers[​](<#recovering-stuck-workers> "Direct link to Recovering stuck workers")
...
Hallucination warnings appear on tasks where a worker's `kanban_complete(created_cards=[...])` claim included card ids that don't exist or weren't created by the worker's profile (the gate blocks the completion), or where the free-form summary references `t_<hex>` ids that don't resolve (advisory prose scan, non-blocking). Both produce audit events that persist even after recovery actions — the trail stays for debugging.
  ...
  * [When to use the board (vs. just doing the work)](<#when-to-use-the-board-vs-just-doing-the-work>)
  * [The anti-temptation rules](<#the-anti-temptation-rules>)
  * [The standard specialist roster (convention)](<#the-standard-specialist-roster-convention>)
  * [Decomposition playbook](<#decomposition-playbook>)
    * [Step 1 — Understand the goal](<#step-1--understand-the-goal>)
    * [Step 2 — Sketch the task graph](<#step-2--sketch-the-task-graph>)
    * [Step 3 — Create tasks and link](<#step-3--create-tasks-and-link>)
    * [Step 4 — Complete your own task](<#step-4--complete-your-own-task>)
    * [Step 5 — Report back to the user](<#step-5--report-back-to-the-user>)
  * [Common patterns](<#common-patterns>)
  * [Pitfalls](<#pitfalls>)
  * [Recovering stuck workers](<#recovering-stuck-workers>)
