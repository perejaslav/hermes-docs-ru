...
## CRITICAL: How Messaging Works[​](<#critical-how-messaging-works> "Direct link to CRITICAL: How Messaging Works")
...
## @Mention Workflow[​](<#mention-workflow> "Direct link to @Mention Workflow")
...
## Send DM (Private Message) Workflow[​](<#send-dm-private-message-workflow> "Direct link to Send DM \(Private Message\) Workflow")
...
## Query Group Info[​](<#query-group-info> "Direct link to Query Group Info")
[code] 
    yb_query_group_info({ "group_code": "328306697" })  
    
[/code]
## Query Members[​](<#query-members> "Direct link to Query Members")
Action| Description  
---|---  
