...
## Required Frontmatter[​](<#required-frontmatter> "Direct link to Required Frontmatter")
...
## Peer-Matched Structure[​](<#peer-matched-structure> "Direct link to Peer-Matched Structure")
...
## Directory Placement[​](<#directory-placement> "Direct link to Directory Placement")
[code] 
...
## Cross-Referencing Other Skills[​](<#cross-referencing-other-skills> "Direct link to Cross-Referencing Other Skills")
`metadata.hermes.related_skills` unions both trees (`skills/` in-repo and `~/.hermes/skills/`) at load time. You CAN reference a user-local skill from an in-repo skill, but it won't resolve for other users who clone the repo fresh. Prefer referencing only in-repo skills from in-repo skills. If a frequently-referenced skill lives only in `~/.hermes/skills/`, consider promoting it to the repo.
## Editing Existing In-Repo Skills[​](<#editing-existing-in-repo-skills> "Direct link to Editing Existing In-Repo Skills")
...
## Verification Checklist[​](<#verification-checklist> "Direct link to Verification Checklist")
  ...
  * [Peer-Matched Structure](<#peer-matched-structure>)
  * [Directory Placement](<#directory-placement>)
  * [Workflow](<#workflow>)
  * [Cross-Referencing Other Skills](<#cross-referencing-other-skills>)
  * [Editing Existing In-Repo Skills](<#editing-existing-in-repo-skills>)
