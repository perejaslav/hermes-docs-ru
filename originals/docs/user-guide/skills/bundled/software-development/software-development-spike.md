...
[/code]
### 1\. Decompose[​](<#1-decompose> "Direct link to 1. Decompose")
...
### 2\. Align (for multi-spike ideas)[​](<#2-align-for-multi-spike-ideas> "Direct link to 2. Align \(for multi-spike ideas\)")
...
### 3\. Research (per spike, before building)[​](<#3-research-per-spike-before-building> "Direct link to 3. Research \(per spike, before building\)")
...
### 4\. Build[​](<#4-build> "Direct link to 4. Build")
...
[/code]
**Bias toward something the user can interact with.** Spikes fail when the only output is a log line that says "it works." The user wants to _feel_ the spike working. Default choices, in order of preference:
...
### 5\. Verdict[​](<#5-verdict> "Direct link to 5. Verdict")
...
## Comparison spikes[​](<#comparison-spikes> "Direct link to Comparison spikes")
...
[/code]
## Frontier mode (picking what to spike next)[​](<#frontier-mode-picking-what-to-spike-next> "Direct link to Frontier mode \(picking what to spike next\)")
...
Adapted from the GSD (Get Shit Done) project's `/gsd-spike` workflow — MIT © 2025 Lex Christopherson ([gsd-build/get-shit-done](<https://github.com/gsd-build/get-shit-done>)). The full GSD system offers persistent spike state, MANIFEST tracking, and integration with a broader spec-driven development pipeline; install with `npx get-shit-done-cc --hermes --global`.
  ...
  * [Core method](<#core-method>)
    * [1\. Decompose](<#1-decompose>)
    * [2\. Align (for multi-spike ideas)](<#2-align-for-multi-spike-ideas>)
    * [3\. Research (per spike, before building)](<#3-research-per-spike-before-building>)
    * [4\. Build](<#4-build>)
    * [5\. Verdict](<#5-verdict>)
  * [Comparison spikes](<#comparison-spikes>)
  * [Frontier mode (picking what to spike next)](<#frontier-mode-picking-what-to-spike-next>)
  * [Output](<#output>)
