...
## Quick Reference: `node inspect` REPL[​](<#quick-reference-node-inspect-repl> "Direct link to quick-reference-node-inspect-repl")
...
## Attaching to a Running Process[​](<#attaching-to-a-running-process> "Direct link to Attaching to a Running Process")
...
[/code]
## Programmatic CDP (scripting from terminal)[​](<#programmatic-cdp-scripting-from-terminal> "Direct link to Programmatic CDP \(scripting from terminal\)")
...
[/code]
## Debugging Hermes ui-tui[​](<#debugging-hermes-ui-tui> "Direct link to Debugging Hermes ui-tui")
The TUI is built Ink + tsx. Two common scenarios:
### Debugging a single Ink component under dev[​](<#debugging-a-single-ink-component-under-dev> "Direct link to Debugging a single Ink component under dev")
...
### Debugging a running `hermes --tui`[​](<#debugging-a-running-hermes---tui> "Direct link to debugging-a-running-hermes---tui")
...
### Debugging `_SlashWorker` / PTY child processes[​](<#debugging-_slashworker--pty-child-processes> "Direct link to debugging-_slashworker--pty-child-processes")
...
## Running Vitest Tests Under the Debugger[​](<#running-vitest-tests-under-the-debugger> "Direct link to Running Vitest Tests Under the Debugger")
[code] 
    cd /home/bb/hermes-agent/ui-tui  
...
## Heap Snapshots & CPU Profiles (Non-interactive)[​](<#heap-snapshots--cpu-profiles-non-interactive> "Direct link to Heap Snapshots & CPU Profiles \(Non-interactive\)")
...
[code] curl -s http://127.0.0.1:9229/json/list   # lists all inspectable targets on the host  
...
[/code]
  ...
  * [Quick Reference: `node inspect` REPL](<#quick-reference-node-inspect-repl>)
  ...
  * [Debugging Hermes ui-tui](<#debugging-hermes-ui-tui>)
    * [Debugging a single Ink component under dev](<#debugging-a-single-ink-component-under-dev>)
    * [Debugging a running `hermes --tui`](<#debugging-a-running-hermes---tui>)
    * [Debugging `_SlashWorker` / PTY child processes](<#debugging-_slashworker--pty-child-processes>)
  * [Running Vitest Tests Under the Debugger](<#running-vitest-tests-under-the-debugger>)
