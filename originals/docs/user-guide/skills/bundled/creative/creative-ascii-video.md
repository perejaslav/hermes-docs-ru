...
## Pipeline Architecture[​](<#pipeline-architecture> "Direct link to Pipeline Architecture")
...
### Per-Section Variation[​](<#per-section-variation> "Direct link to Per-Section Variation")
...
### Step 3: Build the Script[​](<#step-3-build-the-script> "Direct link to Step 3: Build the Script")
...
### Step 4: Quality Verification[​](<#step-4-quality-verification> "Direct link to Step 4: Quality Verification")
...
### Brightness — Use `tonemap()`, Not Linear Multipliers[​](<#brightness--use-tonemap-not-linear-multipliers> "Direct link to brightness--use-tonemap-not-linear-multipliers")
...
### Font Cell Height[​](<#font-cell-height> "Direct link to Font Cell Height")
...
### ffmpeg Pipe Deadlock[​](<#ffmpeg-pipe-deadlock> "Direct link to ffmpeg Pipe Deadlock")
...
### Font Compatibility[​](<#font-compatibility> "Direct link to Font Compatibility")
...
### Per-Clip Architecture[​](<#per-clip-architecture> "Direct link to Per-Clip Architecture")
...
### Forced Connections[​](<#forced-connections> "Direct link to Forced Connections")
...
### Oblique Strategies[​](<#oblique-strategies> "Direct link to Oblique Strategies")
  ...
  * [Creative Direction](<#creative-direction>)
    ...
    * [Per-Section Variation](<#per-section-variation>)
  ...
  * [Workflow](<#workflow>)
    ...
    * [Step 3: Build the Script](<#step-3-build-the-script>)
    * [Step 4: Quality Verification](<#step-4-quality-verification>)
  * [Critical Implementation Notes](<#critical-implementation-notes>)
    * [Brightness — Use `tonemap()`, Not Linear Multipliers](<#brightness--use-tonemap-not-linear-multipliers>)
    * [Font Cell Height](<#font-cell-height>)
    * [ffmpeg Pipe Deadlock](<#ffmpeg-pipe-deadlock>)
    * [Font Compatibility](<#font-compatibility>)
    * [Per-Clip Architecture](<#per-clip-architecture>)
