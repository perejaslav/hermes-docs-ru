...
## What's in this skill[​](<#whats-in-this-skill> "Direct link to What's in this skill")
...
## Architecture: Two Layers[​](<#architecture-two-layers> "Direct link to Architecture: Two Layers")
[code] 
    ┌─────────────────────────────────────────────────────┐  
...
### Detect environment[​](<#detect-environment> "Direct link to Detect environment")
[code] 
    # What's available?  
...
### One-line health check[​](<#one-line-health-check> "Direct link to One-line health check")
[code] 
    python3 scripts/health_check.py  
    # → JSON: comfy_cli on PATH? server reachable? at least one checkpoint? smoke-test passes?  
    
[/code]
## Core Workflow[​](<#core-workflow> "Direct link to Core Workflow")
### Step 1: Get a workflow JSON in API format[​](<#step-1-get-a-workflow-json-in-api-format> "Direct link to Step 1: Get a workflow JSON in API format")
...
### Step 2: See what's controllable[​](<#step-2-see-whats-controllable> "Direct link to Step 2: See what's controllable")
[code] 
...
[/code]
### Step 3: Run with parameters[​](<#step-3-run-with-parameters> "Direct link to Step 3: Run with parameters")
[code] 
...
### Step 4: Present results[​](<#step-4-present-results> "Direct link to Step 4: Present results")
...
### Step 0: Ask Local vs Cloud (ALWAYS FIRST)[​](<#step-0-ask-local-vs-cloud-always-first> "Direct link to Step 0: Ask Local vs Cloud \(ALWAYS FIRST\)")
Suggested script:
...
### Step 1: Verify Hardware (ONLY if user chose local)[​](<#step-1-verify-hardware-only-if-user-chose-local> "Direct link to Step 1: Verify Hardware \(ONLY if user chose local\)")
[code] 
...
### Choosing an Installation Path[​](<#choosing-an-installation-path> "Direct link to Choosing an Installation Path")
...
* * *
### Path A: Comfy Cloud (No Local Install)[​](<#path-a-comfy-cloud-no-local-install> "Direct link to Path A: Comfy Cloud \(No Local Install\)")
...
* * *
### Path C: ComfyUI Portable (Windows Only)[​](<#path-c-comfyui-portable-windows-only> "Direct link to Path C: ComfyUI Portable \(Windows Only\)")
...
* * *
### Path D: comfy-cli (All Platforms — Recommended for Agents)[​](<#path-d-comfy-cli-all-platforms--recommended-for-agents> "Direct link to Path D: comfy-cli \(All Platforms — Recommended for Agents\)")
The official CLI is the best path for headless/automated setups.
**Docs:** <https://docs.comfy.org/comfy-cli/getting-started>
#### Install comfy-cli[​](<#install-comfy-cli> "Direct link to Install comfy-cli")
[code] 
    # Recommended:  
...
[/code]
#### Install ComfyUI[​](<#install-comfyui> "Direct link to Install ComfyUI")
[code] 
...
#### Launch / verify[​](<#launch--verify> "Direct link to Launch / verify")
[code] 
...
[/code]
* * *
### Path E: Manual Install (Advanced / Unsupported Hardware)[​](<#path-e-manual-install-advanced--unsupported-hardware> "Direct link to Path E: Manual Install \(Advanced / Unsupported Hardware\)")
...
[/code]
* * *
### Post-Install: Download Models[​](<#post-install-download-models> "Direct link to Post-Install: Download Models")
[code] 
...
### Post-Install: Install Custom Nodes[​](<#post-install-install-custom-nodes> "Direct link to Post-Install: Install Custom Nodes")
[code] 
...
[/code]
### Post-Install: Verify[​](<#post-install-verify> "Direct link to Post-Install: Verify")
[code] 
    python3 scripts/health_check.py  
...
[/code]
## Image Upload (img2img / Inpainting)[​](<#image-upload-img2img--inpainting> "Direct link to Image Upload \(img2img / Inpainting\)")
...
[/code]
## Cloud Specifics[​](<#cloud-specifics> "Direct link to Cloud Specifics")
...
## Queue & System Management[​](<#queue--system-management> "Direct link to Queue & System Management")
[code] 
    # Local  
...
Use `python3 scripts/health_check.py` to run the whole list at once. Manual:
  ...
  * [Architecture: Two Layers](<#architecture-two-layers>)
  * [Quick Start](<#quick-start>)
    * [Detect environment](<#detect-environment>)
    * [One-line health check](<#one-line-health-check>)
  * [Core Workflow](<#core-workflow>)
    * [Step 1: Get a workflow JSON in API format](<#step-1-get-a-workflow-json-in-api-format>)
    * [Step 2: See what's controllable](<#step-2-see-whats-controllable>)
    * [Step 3: Run with parameters](<#step-3-run-with-parameters>)
    * [Step 4: Present results](<#step-4-present-results>)
  * [Decision Tree](<#decision-tree>)
  * [Setup & Onboarding](<#setup--onboarding>)
    * [Step 0: Ask Local vs Cloud (ALWAYS FIRST)](<#step-0-ask-local-vs-cloud-always-first>)
    * [Step 1: Verify Hardware (ONLY if user chose local)](<#step-1-verify-hardware-only-if-user-chose-local>)
    * [Choosing an Installation Path](<#choosing-an-installation-path>)
    * [Path A: Comfy Cloud (No Local Install)](<#path-a-comfy-cloud-no-local-install>)
    * [Path B: ComfyUI Desktop (Windows / macOS)](<#path-b-comfyui-desktop-windows--macos>)
    * [Path C: ComfyUI Portable (Windows Only)](<#path-c-comfyui-portable-windows-only>)
    * [Path D: comfy-cli (All Platforms — Recommended for Agents)](<#path-d-comfy-cli-all-platforms--recommended-for-agents>)
    * [Path E: Manual Install (Advanced / Unsupported Hardware)](<#path-e-manual-install-advanced--unsupported-hardware>)
