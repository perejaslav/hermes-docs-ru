...
* * *
## Secret Safety (MANDATORY)[​](<#secret-safety-mandatory> "Direct link to Secret Safety \(MANDATORY\)")
...
* * *
## One-Time User Setup (user runs these outside the agent)[​](<#one-time-user-setup-user-runs-these-outside-the-agent> "Direct link to One-Time User Setup \(user runs these outside the agent\)")
...
* * *
## Command Details[​](<#command-details> "Direct link to Command Details")
### Posting[​](<#posting> "Direct link to Posting")
[code] 
...
[/code]
### Reading & Search[​](<#reading--search> "Direct link to Reading & Search")
[code] 
...
[/code]
### Users, Timeline, Mentions[​](<#users-timeline-mentions> "Direct link to Users, Timeline, Mentions")
[code] 
    xurl whoami  
    xurl user elonmusk  
...
[/code]
### Engagement[​](<#engagement> "Direct link to Engagement")
[code] 
...
[/code]
### Social Graph[​](<#social-graph> "Direct link to Social Graph")
[code] 
...
[/code]
### Media Upload[​](<#media-upload> "Direct link to Media Upload")
[code] 
    # Auto-detect type  
...
[/code]
* * *
## Raw API Access[​](<#raw-api-access> "Direct link to Raw API Access")
...
### Post with an image[​](<#post-with-an-image> "Direct link to Post with an image")
[code] 
    xurl media upload photo.jpg  
    xurl post "Check out this photo!" --media-id MEDIA_ID  
    
[/code]
### Reply to a conversation[​](<#reply-to-a-conversation> "Direct link to Reply to a conversation")
[code] 
    xurl read https://x.com/user/status/1234567890  
    xurl reply 1234567890 "Here are my thoughts..."  
    
[/code]
### Search and engage[​](<#search-and-engage> "Direct link to Search and engage")
[code] 
...
[/code]
### Check your activity[​](<#check-your-activity> "Direct link to Check your activity")
[code] 
    xurl whoami  
    xurl mentions -n 20  
    xurl timeline -n 20  
...
[/code]
### Multiple apps (credentials pre-configured manually)[​](<#multiple-apps-credentials-pre-configured-manually> "Direct link to Multiple apps \(credentials pre-configured manually\)")
[code] 
...
## Attribution[​](<#attribution> "Direct link to Attribution")
  ...
  * [Secret Safety (MANDATORY)](<#secret-safety-mandatory>)
  * [Installation](<#installation>)
  * [One-Time User Setup (user runs these outside the agent)](<#one-time-user-setup-user-runs-these-outside-the-agent>)
  * [Quick Reference](<#quick-reference>)
  * [Command Details](<#command-details>)
    * [Posting](<#posting>)
    * [Reading & Search](<#reading--search>)
    * [Users, Timeline, Mentions](<#users-timeline-mentions>)
  ...
  * [Common Workflows](<#common-workflows>)
    * [Post with an image](<#post-with-an-image>)
    * [Reply to a conversation](<#reply-to-a-conversation>)
    * [Search and engage](<#search-and-engage>)
    * [Check your activity](<#check-your-activity>)
    * [Multiple apps (credentials pre-configured manually)](<#multiple-apps-credentials-pre-configured-manually>)
