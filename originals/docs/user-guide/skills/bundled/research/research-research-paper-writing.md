...
## Core Philosophy[​](<#core-philosophy> "Direct link to Core Philosophy")
...
### Proactivity and Collaboration[​](<#proactivity-and-collaboration> "Direct link to Proactivity and Collaboration")
...
* * *
## Phase 0: Project Setup[​](<#phase-0-project-setup> "Direct link to Phase 0: Project Setup")
**Goal** : Establish the workspace, understand existing work, identify the contribution.
### Step 0.1: Explore the Repository[​](<#step-01-explore-the-repository> "Direct link to Step 0.1: Explore the Repository")
[code] 
...
### Step 0.2: Organize the Workspace[​](<#step-02-organize-the-workspace> "Direct link to Step 0.2: Organize the Workspace")
...
[/code]
### Step 0.3: Set Up Version Control[​](<#step-03-set-up-version-control> "Direct link to Step 0.3: Set Up Version Control")
[code] 
...
[/code]
### Step 0.4: Identify the Contribution[​](<#step-04-identify-the-contribution> "Direct link to Step 0.4: Identify the Contribution")
...
### Step 0.5: Create a TODO List[​](<#step-05-create-a-todo-list> "Direct link to Step 0.5: Create a TODO List")
...
### Step 0.6: Estimate Compute Budget[​](<#step-06-estimate-compute-budget> "Direct link to Step 0.6: Estimate Compute Budget")
...
### Step 0.7: Multi-Author Coordination[​](<#step-07-multi-author-coordination> "Direct link to Step 0.7: Multi-Author Coordination")
...
* * *
## Phase 1: Literature Review[​](<#phase-1-literature-review> "Direct link to Phase 1: Literature Review")
**Goal** : Find related work, identify baselines, gather citations.
### Step 1.1: Identify Seed Papers[​](<#step-11-identify-seed-papers> "Direct link to Step 1.1: Identify Seed Papers")
...
[/code]
### Step 1.2: Search for Related Work[​](<#step-12-search-for-related-work> "Direct link to Step 1.2: Search for Related Work")
...
[/code]
### Step 1.2b: Deepen the Search (Breadth-First, Then Depth)[​](<#step-12b-deepen-the-search-breadth-first-then-depth> "Direct link to Step 1.2b: Deepen the Search \(Breadth-First, Then Depth\)")
...
### Step 1.3: Verify Every Citation[​](<#step-13-verify-every-citation> "Direct link to Step 1.3: Verify Every Citation")
...
### Step 1.4: Organize Related Work[​](<#step-14-organize-related-work> "Direct link to Step 1.4: Organize Related Work")
...
* * *
## Phase 2: Experiment Design[​](<#phase-2-experiment-design> "Direct link to Phase 2: Experiment Design")
**Goal** : Design experiments that directly support paper claims. Every experiment must answer a specific question.
### Step 2.1: Map Claims to Experiments[​](<#step-21-map-claims-to-experiments> "Direct link to Step 2.1: Map Claims to Experiments")
...
### Step 2.2: Design Baselines[​](<#step-22-design-baselines> "Direct link to Step 2.2: Design Baselines")
...
### Step 2.3: Define Evaluation Protocol[​](<#step-23-define-evaluation-protocol> "Direct link to Step 2.3: Define Evaluation Protocol")
...
### Step 2.4: Write Experiment Scripts[​](<#step-24-write-experiment-scripts> "Direct link to Step 2.4: Write Experiment Scripts")
...
### Step 2.5: Design Human Evaluation (If Applicable)[​](<#step-25-design-human-evaluation-if-applicable> "Direct link to Step 2.5: Design Human Evaluation \(If Applicable\)")
...
* * *
## Phase 3: Experiment Execution & Monitoring[​](<#phase-3-experiment-execution--monitoring> "Direct link to Phase 3: Experiment Execution & Monitoring")
**Goal** : Run experiments reliably, monitor progress, recover from failures.
### Step 3.1: Launch Experiments[​](<#step-31-launch-experiments> "Direct link to Step 3.1: Launch Experiments")
...
### Step 3.2: Set Up Monitoring (Cron Pattern)[​](<#step-32-set-up-monitoring-cron-pattern> "Direct link to Step 3.2: Set Up Monitoring \(Cron Pattern\)")
...
### Step 3.3: Handle Failures[​](<#step-33-handle-failures> "Direct link to Step 3.3: Handle Failures")
...
### Step 3.4: Commit Completed Results[​](<#step-34-commit-completed-results> "Direct link to Step 3.4: Commit Completed Results")
...
[/code]
### Step 3.5: Maintain an Experiment Journal[​](<#step-35-maintain-an-experiment-journal> "Direct link to Step 3.5: Maintain an Experiment Journal")
...
* * *
## Phase 4: Result Analysis[​](<#phase-4-result-analysis> "Direct link to Phase 4: Result Analysis")
**Goal** : Extract findings, compute statistics, identify the story.
### Step 4.1: Aggregate Results[​](<#step-41-aggregate-results> "Direct link to Step 4.1: Aggregate Results")
...
[/code]
### Step 4.2: Statistical Significance[​](<#step-42-statistical-significance> "Direct link to Step 4.2: Statistical Significance")
Always compute:
...
### Step 4.3: Identify the Story[​](<#step-43-identify-the-story> "Direct link to Step 4.3: Identify the Story")
...
#### Handling Negative or Null Results[​](<#handling-negative-or-null-results> "Direct link to Handling Negative or Null Results")
...
### Step 4.4: Create Figures and Tables[​](<#step-44-create-figures-and-tables> "Direct link to Step 4.4: Create Figures and Tables")
**Figures** :
...
[/code]
### Step 4.5: Decide: More Experiments or Write?[​](<#step-45-decide-more-experiments-or-write> "Direct link to Step 4.5: Decide: More Experiments or Write?")
Situation| Action  
---|---  
...
### Step 4.6: Write the Experiment Log (Bridge to Writeup)[​](<#step-46-write-the-experiment-log-bridge-to-writeup> "Direct link to Step 4.6: Write the Experiment Log \(Bridge to Writeup\)")
...
* * *
## Iterative Refinement: Strategy Selection[​](<#iterative-refinement-strategy-selection> "Direct link to Iterative Refinement: Strategy Selection")
...
### Quick Decision Table[​](<#quick-decision-table> "Direct link to Quick Decision Table")
...
Code with test cases| **Autoreason (code variant)**|  Structured analysis of _why_ it failed before fixing. Recovery rate 62% vs 43%.  
Very weak model (Llama 8B class)| **Single pass**|  Model too weak for diverse candidates. Invest in generation quality.  
### The Generation-Evaluation Gap[​](<#the-generation-evaluation-gap> "Direct link to The Generation-Evaluation Gap")
...
### Autoreason Loop (Summary)[​](<#autoreason-loop-summary> "Direct link to Autoreason Loop \(Summary\)")
...
### Applying to Paper Drafts[​](<#applying-to-paper-drafts> "Direct link to Applying to Paper Drafts")
...
* * *
## Phase 5: Paper Drafting[​](<#phase-5-paper-drafting> "Direct link to Phase 5: Paper Drafting")
**Goal** : Write a complete, publication-ready paper.
### Context Management for Large Projects[​](<#context-management-for-large-projects> "Direct link to Context Management for Large Projects")
...
### The Narrative Principle[​](<#the-narrative-principle> "Direct link to The Narrative Principle")
...
### The Sources Behind This Guidance[​](<#the-sources-behind-this-guidance> "Direct link to The Sources Behind This Guidance")
...
### Time Allocation[​](<#time-allocation> "Direct link to Time Allocation")
...
### Writing Workflow[​](<#writing-workflow> "Direct link to Writing Workflow")
[code] 
...
[/code]
### Two-Pass Refinement Pattern[​](<#two-pass-refinement-pattern> "Direct link to Two-Pass Refinement Pattern")
...
[/code]
### LaTeX Error Checklist[​](<#latex-error-checklist> "Direct link to LaTeX Error Checklist")
...
[/code]
### Step 5.0: Title[​](<#step-50-title> "Direct link to Step 5.0: Title")
...
### Step 5.1: Abstract (5-Sentence Formula)[​](<#step-51-abstract-5-sentence-formula> "Direct link to Step 5.1: Abstract \(5-Sentence Formula\)")
...
### Step 5.2: Figure 1[​](<#step-52-figure-1> "Direct link to Step 5.2: Figure 1")
...
### Step 5.3: Introduction (1-1.5 pages max)[​](<#step-53-introduction-1-15-pages-max> "Direct link to Step 5.3: Introduction \(1-1.5 pages max\)")
Must include:
...
### Step 5.4: Methods[​](<#step-54-methods> "Direct link to Step 5.4: Methods")
...
### Step 5.5: Experiments & Results[​](<#step-55-experiments--results> "Direct link to Step 5.5: Experiments & Results")
...
### Step 5.6: Related Work[​](<#step-56-related-work> "Direct link to Step 5.6: Related Work")
Organize methodologically, not paper-by-paper. Cite generously — reviewers likely authored relevant papers.
### Step 5.7: Limitations (REQUIRED)[​](<#step-57-limitations-required> "Direct link to Step 5.7: Limitations \(REQUIRED\)")
...
### Step 5.8: Conclusion & Discussion[​](<#step-58-conclusion--discussion> "Direct link to Step 5.8: Conclusion & Discussion")
...
### Step 5.9: Appendix Strategy[​](<#step-59-appendix-strategy> "Direct link to Step 5.9: Appendix Strategy")
...
### Page Budget Management[​](<#page-budget-management> "Direct link to Page Budget Management")
...
### Step 5.10: Ethics & Broader Impact Statement[​](<#step-510-ethics--broader-impact-statement> "Direct link to Step 5.10: Ethics & Broader Impact Statement")
...
[/code]
### Step 5.11: Datasheets & Model Cards (If Applicable)[​](<#step-511-datasheets--model-cards-if-applicable> "Direct link to Step 5.11: Datasheets & Model Cards \(If Applicable\)")
...
### Using LaTeX Templates[​](<#using-latex-templates> "Direct link to Using LaTeX Templates")
...
[/code]
### Template Pitfalls[​](<#template-pitfalls> "Direct link to Template Pitfalls")
...
### Quick Template Reference[​](<#quick-template-reference> "Direct link to Quick Template Reference")
...
### Tables and Figures[​](<#tables-and-figures> "Direct link to Tables and Figures")
...
### Conference Resubmission[​](<#conference-resubmission> "Direct link to Conference Resubmission")
...
### Professional LaTeX Preamble[​](<#professional-latex-preamble> "Direct link to Professional LaTeX Preamble")
...
### siunitx Table Alignment[​](<#siunitx-table-alignment> "Direct link to siunitx Table Alignment")
...
### Subfigures[​](<#subfigures> "Direct link to Subfigures")
...
### Pseudocode with algorithm2e[​](<#pseudocode-with-algorithm2e> "Direct link to Pseudocode with algorithm2e")
[code] 
    \begin{algorithm}[t]  
...
[/code]
### TikZ Diagram Patterns[​](<#tikz-diagram-patterns> "Direct link to TikZ Diagram Patterns")
...
[/code]
### latexdiff for Revision Tracking[​](<#latexdiff-for-revision-tracking> "Direct link to latexdiff for Revision Tracking")
...
### SciencePlots for matplotlib[​](<#scienceplots-for-matplotlib> "Direct link to SciencePlots for matplotlib")
...
* * *
## Phase 6: Self-Review & Revision[​](<#phase-6-self-review--revision> "Direct link to Phase 6: Self-Review & Revision")
**Goal** : Simulate the review process before submission. Catch weaknesses early.
### Step 6.1: Simulate Reviews (Ensemble Pattern)[​](<#step-61-simulate-reviews-ensemble-pattern> "Direct link to Step 6.1: Simulate Reviews \(Ensemble Pattern\)")
...
### Step 6.1b: Visual Review Pass (VLM)[​](<#step-61b-visual-review-pass-vlm> "Direct link to Step 6.1b: Visual Review Pass \(VLM\)")
...
### Step 6.1c: Claim Verification Pass[​](<#step-61c-claim-verification-pass> "Direct link to Step 6.1c: Claim Verification Pass")
...
### Step 6.2: Prioritize Feedback[​](<#step-62-prioritize-feedback> "Direct link to Step 6.2: Prioritize Feedback")
...
### Step 6.3: Revision Cycle[​](<#step-63-revision-cycle> "Direct link to Step 6.3: Revision Cycle")
...
### Step 6.4: Rebuttal Writing[​](<#step-64-rebuttal-writing> "Direct link to Step 6.4: Rebuttal Writing")
...
### Step 6.5: Paper Evolution Tracking[​](<#step-65-paper-evolution-tracking> "Direct link to Step 6.5: Paper Evolution Tracking")
...
[/code]
* * *
## Phase 7: Submission Preparation[​](<#phase-7-submission-preparation> "Direct link to Phase 7: Submission Preparation")
**Goal** : Final checks, formatting, and submission.
### Step 7.1: Conference Checklist[​](<#step-71-conference-checklist> "Direct link to Step 7.1: Conference Checklist")
...
### Step 7.2: Anonymization Checklist[​](<#step-72-anonymization-checklist> "Direct link to Step 7.2: Anonymization Checklist")
...
### Step 7.3: Formatting Verification[​](<#step-73-formatting-verification> "Direct link to Step 7.3: Formatting Verification")
[code] 
...
[/code]
### Step 7.4: Pre-Compilation Validation[​](<#step-74-pre-compilation-validation> "Direct link to Step 7.4: Pre-Compilation Validation")
...
### Step 7.5: Final Compilation[​](<#step-75-final-compilation> "Direct link to Step 7.5: Final Compilation")
[code] 
    # Clean build  
...
### Step 7.6: Conference-Specific Requirements[​](<#step-76-conference-specific-requirements> "Direct link to Step 7.6: Conference-Specific Requirements")
...
### Step 7.7: Conference Resubmission & Format Conversion[​](<#step-77-conference-resubmission--format-conversion> "Direct link to Step 7.7: Conference Resubmission & Format Conversion")
...
### Step 7.8: Camera-Ready Preparation (Post-Acceptance)[​](<#step-78-camera-ready-preparation-post-acceptance> "Direct link to Step 7.8: Camera-Ready Preparation \(Post-Acceptance\)")
...
[/code]
### Step 7.9: arXiv & Preprint Strategy[​](<#step-79-arxiv--preprint-strategy> "Direct link to Step 7.9: arXiv & Preprint Strategy")
...
[/code]
### Step 7.10: Research Code Packaging[​](<#step-710-research-code-packaging> "Direct link to Step 7.10: Research Code Packaging")
...
[/code]
* * *
## Phase 8: Post-Acceptance Deliverables[​](<#phase-8-post-acceptance-deliverables> "Direct link to Phase 8: Post-Acceptance Deliverables")
**Goal** : Maximize the impact of your accepted paper through presentation materials and community engagement.
### Step 8.1: Conference Poster[​](<#step-81-conference-poster> "Direct link to Step 8.1: Conference Poster")
...
### Step 8.2: Conference Talk / Spotlight[​](<#step-82-conference-talk--spotlight> "Direct link to Step 8.2: Conference Talk / Spotlight")
...
### Step 8.3: Blog Post / Social Media[​](<#step-83-blog-post--social-media> "Direct link to Step 8.3: Blog Post / Social Media")
...
* * *
## Workshop & Short Papers[​](<#workshop--short-papers> "Direct link to Workshop & Short Papers")
...
### Workshop Papers[​](<#workshop-papers> "Direct link to Workshop Papers")
...
### ACL Short Papers & Findings[​](<#acl-short-papers--findings> "Direct link to ACL Short Papers & Findings")
...
* * *
## Paper Types Beyond Empirical ML[​](<#paper-types-beyond-empirical-ml> "Direct link to Paper Types Beyond Empirical ML")
...
### Theory Papers[​](<#theory-papers> "Direct link to Theory Papers")
...
### Survey / Tutorial Papers[​](<#survey--tutorial-papers> "Direct link to Survey / Tutorial Papers")
...
### Benchmark Papers[​](<#benchmark-papers> "Direct link to Benchmark Papers")
...
### Position Papers[​](<#position-papers> "Direct link to Position Papers")
...
### Hermes Tools Reference[​](<#hermes-tools-reference> "Direct link to Hermes Tools Reference")
...
### Tool Usage Patterns[​](<#tool-usage-patterns> "Direct link to Tool Usage Patterns")
...
[/code]
### State Management with `memory` and `todo`[​](<#state-management-with-memory-and-todo> "Direct link to state-management-with-memory-and-todo")
...
[/code]
### Cron Monitoring with `cronjob`[​](<#cron-monitoring-with-cronjob> "Direct link to cron-monitoring-with-cronjob")
...
[/code]
### Communication Patterns[​](<#communication-patterns> "Direct link to Communication Patterns")
...
[/code]
### Decision Points Requiring Human Input[​](<#decision-points-requiring-human-input> "Direct link to Decision Points Requiring Human Input")
...
* * *
## Reviewer Evaluation Criteria[​](<#reviewer-evaluation-criteria> "Direct link to Reviewer Evaluation Criteria")
...
* * *
## Reference Documents[​](<#reference-documents> "Direct link to Reference Documents")
Document| Contents  
---|---  
...
### LaTeX Templates[​](<#latex-templates> "Direct link to LaTeX Templates")
...
### Key External Sources[​](<#key-external-sources> "Direct link to Key External Sources")
**Writing Philosophy:**
...
**Venues:** [NeurIPS](<https://neurips.cc/Conferences/2025/PaperInformation/StyleFiles>) | [ICML](<https://icml.cc/Conferences/2025/AuthorInstructions>) | [ICLR](<https://iclr.cc/Conferences/2026/AuthorGuide>) | [ACL](<https://github.com/acl-org/acl-style-files>)
  ...
  * [Phase 3: Experiment Execution & Monitoring](<#phase-3-experiment-execution--monitoring>)
    * [Step 3.1: Launch Experiments](<#step-31-launch-experiments>)
    * [Step 3.2: Set Up Monitoring (Cron Pattern)](<#step-32-set-up-monitoring-cron-pattern>)
    * [Step 3.3: Handle Failures](<#step-33-handle-failures>)
    * [Step 3.4: Commit Completed Results](<#step-34-commit-completed-results>)
    * [Step 3.5: Maintain an Experiment Journal](<#step-35-maintain-an-experiment-journal>)
  ...
  * [Iterative Refinement: Strategy Selection](<#iterative-refinement-strategy-selection>)
    * [Quick Decision Table](<#quick-decision-table>)
    * [The Generation-Evaluation Gap](<#the-generation-evaluation-gap>)
    * [Autoreason Loop (Summary)](<#autoreason-loop-summary>)
    * [Applying to Paper Drafts](<#applying-to-paper-drafts>)
  ...
  * [Phase 8: Post-Acceptance Deliverables](<#phase-8-post-acceptance-deliverables>)
    * [Step 8.1: Conference Poster](<#step-81-conference-poster>)
    * [Step 8.2: Conference Talk / Spotlight](<#step-82-conference-talk--spotlight>)
    * [Step 8.3: Blog Post / Social Media](<#step-83-blog-post--social-media>)
  ...
  * [Paper Types Beyond Empirical ML](<#paper-types-beyond-empirical-ml>)
    * [Theory Papers](<#theory-papers>)
    * [Survey / Tutorial Papers](<#survey--tutorial-papers>)
  ...
  * [Reviewer Evaluation Criteria](<#reviewer-evaluation-criteria>)
  * [Common Issues and Solutions](<#common-issues-and-solutions>)
  * [Reference Documents](<#reference-documents>)
    * [LaTeX Templates](<#latex-templates>)
    * [Key External Sources](<#key-external-sources>)
