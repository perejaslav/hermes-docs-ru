...
## When This Skill Activates[​](<#when-this-skill-activates> "Direct link to When This Skill Activates")
...
## Wiki Location[​](<#wiki-location> "Direct link to Wiki Location")
...
## Architecture: Three Layers[​](<#architecture-three-layers> "Direct link to Architecture: Three Layers")
[code] 
    wiki/  
...
## Resuming an Existing Wiki (CRITICAL — do this every session)[​](<#resuming-an-existing-wiki-critical--do-this-every-session> "Direct link to Resuming an Existing Wiki \(CRITICAL — do this every session\)")
...
## Initializing a New Wiki[​](<#initializing-a-new-wiki> "Direct link to Initializing a New Wiki")
...
### SCHEMA.md Template[​](<#schemamd-template> "Direct link to SCHEMA.md Template")
...
### raw/ Frontmatter[​](<#raw-frontmatter> "Direct link to raw/ Frontmatter")
...
## Tag Taxonomy[​](<#tag-taxonomy> "Direct link to Tag Taxonomy")
...
## Page Thresholds[​](<#page-thresholds> "Direct link to Page Thresholds")
...
## Entity Pages[​](<#entity-pages> "Direct link to Entity Pages")
...
## Concept Pages[​](<#concept-pages> "Direct link to Concept Pages")
...
## Comparison Pages[​](<#comparison-pages> "Direct link to Comparison Pages")
...
### log.md Template[​](<#logmd-template> "Direct link to log.md Template")
[code] 
    # Wiki Log  
...
### 1\. Ingest[​](<#1-ingest> "Direct link to 1. Ingest")
...
### 3\. Lint[​](<#3-lint> "Direct link to 3. Lint")
...
## Working with the Wiki[​](<#working-with-the-wiki> "Direct link to Working with the Wiki")
...
[/code]
### Bulk Ingest[​](<#bulk-ingest> "Direct link to Bulk Ingest")
...
### Obsidian Integration[​](<#obsidian-integration> "Direct link to Obsidian Integration")
...
### Obsidian Headless (servers and headless machines)[​](<#obsidian-headless-servers-and-headless-machines> "Direct link to Obsidian Headless \(servers and headless machines\)")
