...
## Gather User Preferences First[​](<#gather-user-preferences-first> "Direct link to Gather User Preferences First")
...
### 1\. Download & Inspect the Pack[​](<#1-download--inspect-the-pack> "Direct link to 1. Download & Inspect the Pack")
[code] 
...
### 2\. Install Java[​](<#2-install-java> "Direct link to 2. Install Java")
...
### 3\. Install the Mod Loader[​](<#3-install-the-mod-loader> "Direct link to 3. Install the Mod Loader")
...
### 4\. Accept EULA[​](<#4-accept-eula> "Direct link to 4. Accept EULA")
[code] 
    echo "eula=true" > ~/minecraft-server/server/eula.txt  
    
[/code]
### 5\. Configure server.properties[​](<#5-configure-serverproperties> "Direct link to 5. Configure server.properties")
...
[/code]
### 6\. Tune JVM Args (user_jvm_args.txt)[​](<#6-tune-jvm-args-user_jvm_argstxt> "Direct link to 6. Tune JVM Args \(user_jvm_args.txt\)")
...
[/code]
### 7\. Open Firewall[​](<#7-open-firewall> "Direct link to 7. Open Firewall")
[code] 
    sudo ufw allow 25565/tcp comment "Minecraft Server"  
    
[/code]
Check with: `sudo ufw status | grep 25565`
### 8\. Create Launch Script[​](<#8-create-launch-script> "Direct link to 8. Create Launch Script")
[code] 
...
### 9\. Set Up Automated Backups[​](<#9-set-up-automated-backups> "Direct link to 9. Set Up Automated Backups")
...
## Verification[​](<#verification> "Direct link to Verification")
  ...
  * [Gather User Preferences First](<#gather-user-preferences-first>)
  * [Steps](<#steps>)
    * [1\. Download & Inspect the Pack](<#1-download--inspect-the-pack>)
    * [2\. Install Java](<#2-install-java>)
    * [3\. Install the Mod Loader](<#3-install-the-mod-loader>)
    * [4\. Accept EULA](<#4-accept-eula>)
    * [5\. Configure server.properties](<#5-configure-serverproperties>)
    * [6\. Tune JVM Args (user_jvm_args.txt)](<#6-tune-jvm-args-user_jvm_argstxt>)
    * [7\. Open Firewall](<#7-open-firewall>)
    * [8\. Create Launch Script](<#8-create-launch-script>)
