...
### Workflow 1: Full RLHF pipeline (SFT → Reward Model → PPO)[​](<#workflow-1-full-rlhf-pipeline-sft--reward-model--ppo> "Direct link to Workflow 1: Full RLHF pipeline \(SFT → Reward Model → PPO\)")
...
[/code]
### Workflow 2: Simple preference alignment with DPO[​](<#workflow-2-simple-preference-alignment-with-dpo> "Direct link to Workflow 2: Simple preference alignment with DPO")
...
[/code]
### Workflow 3: Memory-efficient online RL with GRPO[​](<#workflow-3-memory-efficient-online-rl-with-grpo> "Direct link to Workflow 3: Memory-efficient online RL with GRPO")
...
## Resources[​](<#resources> "Direct link to Resources")
  ...
  * [Common workflows](<#common-workflows>)
    * [Workflow 1: Full RLHF pipeline (SFT → Reward Model → PPO)](<#workflow-1-full-rlhf-pipeline-sft--reward-model--ppo>)
    * [Workflow 2: Simple preference alignment with DPO](<#workflow-2-simple-preference-alignment-with-dpo>)
    * [Workflow 3: Memory-efficient online RL with GRPO](<#workflow-3-memory-efficient-online-rl-with-grpo>)
