...
[/code]
### Extracting Owner/Repo from the Git Remote[​](<#extracting-ownerrepo-from-the-git-remote> "Direct link to Extracting Owner/Repo from the Git Remote")
...
Check out someone's PR| `gh pr checkout N`| `git fetch origin pull/N/head:pr-N && git checkout pr-N`  
  ...
  * [Prerequisites](<#prerequisites>)
    * [Quick Auth Detection](<#quick-auth-detection>)
    * [Extracting Owner/Repo from the Git Remote](<#extracting-ownerrepo-from-the-git-remote>)
  * [1\. Branch Creation](<#1-branch-creation>)
  * [2\. Making Commits](<#2-making-commits>)
  * [3\. Pushing and Creating a PR](<#3-pushing-and-creating-a-pr>)
    * [Push the Branch (same either way)](<#push-the-branch-same-either-way>)
    * [Create the PR](<#create-the-pr>)
  * [4\. Monitoring CI Status](<#4-monitoring-ci-status>)
    * [Check CI Status](<#check-ci-status>)
    * [Poll Until Complete (git + curl)](<#poll-until-complete-git--curl>)
  * [5\. Auto-Fixing CI Failures](<#5-auto-fixing-ci-failures>)
    * [Step 1: Get Failure Details](<#step-1-get-failure-details>)
    * [Step 2: Fix and Push](<#step-2-fix-and-push>)
    * [Step 3: Verify](<#step-3-verify>)
    * [Auto-Fix Loop Pattern](<#auto-fix-loop-pattern>)
  * [6\. Merging](<#6-merging>)
    * [Enable Auto-Merge (curl)](<#enable-auto-merge-curl>)
  * [7\. Complete Workflow Example](<#7-complete-workflow-example>)
  * [Useful PR Commands Reference](<#useful-pr-commands-reference>)
