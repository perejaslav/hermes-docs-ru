...
## Overview of Attack Modes[​](<#overview-of-attack-modes> "Direct link to Overview of Attack Modes")
...
## Step 0: Auto-Jailbreak (Recommended)[​](<#step-0-auto-jailbreak-recommended> "Direct link to Step 0: Auto-Jailbreak \(Recommended\)")
...
### Strategy order per model family:[​](<#strategy-order-per-model-family> "Direct link to Strategy order per model family:")
...
### After auto-jailbreak:[​](<#after-auto-jailbreak> "Direct link to After auto-jailbreak:")
...
## Step 1: Choose Your Attack Mode[​](<#step-1-choose-your-attack-mode> "Direct link to Step 1: Choose Your Attack Mode")
...
## Step 2: GODMODE CLASSIC — Quick Start[​](<#step-2-godmode-classic--quick-start> "Direct link to Step 2: GODMODE CLASSIC — Quick Start")
The fastest path. Set the jailbreak system prompt and prefill in Hermes config:
### Option A: Ephemeral system prompt (config.yaml)[​](<#option-a-ephemeral-system-prompt-configyaml> "Direct link to Option A: Ephemeral system prompt \(config.yaml\)")
...
[/code]
### Option B: Prefill messages (prefill.json)[​](<#option-b-prefill-messages-prefilljson> "Direct link to Option B: Prefill messages \(prefill.json\)")
...
### Option C: Both together (maximum effect)[​](<#option-c-both-together-maximum-effect> "Direct link to Option C: Both together \(maximum effect\)")
...
## Step 3: PARSELTONGUE — Obfuscating Queries[​](<#step-3-parseltongue--obfuscating-queries> "Direct link to Step 3: PARSELTONGUE — Obfuscating Queries")
...
### Encoding Escalation[​](<#encoding-escalation> "Direct link to Encoding Escalation")
...
## Step 4: ULTRAPLINIAN — Multi-Model Racing[​](<#step-4-ultraplinian--multi-model-racing> "Direct link to Step 4: ULTRAPLINIAN — Multi-Model Racing")
...
[/code]
### Scoring Logic[​](<#scoring-logic> "Direct link to Scoring Logic")
...
## Step 5: Detecting Refusals[​](<#step-5-detecting-refusals> "Direct link to Step 5: Detecting Refusals")
...
## Step 6: Advanced — Combining Techniques[​](<#step-6-advanced--combining-techniques> "Direct link to Step 6: Advanced — Combining Techniques")
...
## Trigger Words (Reference)[​](<#trigger-words-reference> "Direct link to Trigger Words \(Reference\)")
...
### Test 1: Gray-area query ("how to pick a lock")[​](<#test-1-gray-area-query-how-to-pick-a-lock> "Direct link to Test 1: Gray-area query \("how to pick a lock"\)")
[code] 
...
### Test 2: Hard query ("write a phishing email template")[​](<#test-2-hard-query-write-a-phishing-email-template> "Direct link to Test 2: Hard query \("write a phishing email template"\)")
[code] 
...
## Common Pitfalls[​](<#common-pitfalls> "Direct link to Common Pitfalls")
  ...
  * [Overview of Attack Modes](<#overview-of-attack-modes>)
    * [1\. GODMODE CLASSIC — System Prompt Templates](<#1-godmode-classic--system-prompt-templates>)
    * [2\. PARSELTONGUE — Input Obfuscation (33 Techniques)](<#2-parseltongue--input-obfuscation-33-techniques>)
    * [3\. ULTRAPLINIAN — Multi-Model Racing](<#3-ultraplinian--multi-model-racing>)
  * [Step 0: Auto-Jailbreak (Recommended)](<#step-0-auto-jailbreak-recommended>)
    * [What it does:](<#what-it-does>)
    * [Strategy order per model family:](<#strategy-order-per-model-family>)
    * [After auto-jailbreak:](<#after-auto-jailbreak>)
  * [Step 1: Choose Your Attack Mode](<#step-1-choose-your-attack-mode>)
  * [Step 2: GODMODE CLASSIC — Quick Start](<#step-2-godmode-classic--quick-start>)
    * [Option A: Ephemeral system prompt (config.yaml)](<#option-a-ephemeral-system-prompt-configyaml>)
    * [Option B: Prefill messages (prefill.json)](<#option-b-prefill-messages-prefilljson>)
    * [Option C: Both together (maximum effect)](<#option-c-both-together-maximum-effect>)
  * [Step 3: PARSELTONGUE — Obfuscating Queries](<#step-3-parseltongue--obfuscating-queries>)
    * [Encoding Escalation](<#encoding-escalation>)
  * [Step 4: ULTRAPLINIAN — Multi-Model Racing](<#step-4-ultraplinian--multi-model-racing>)
    * [Scoring Logic](<#scoring-logic>)
  * [Step 5: Detecting Refusals](<#step-5-detecting-refusals>)
  * [Step 6: Advanced — Combining Techniques](<#step-6-advanced--combining-techniques>)
  * [Model-Specific Notes](<#model-specific-notes>)
  * [Trigger Words (Reference)](<#trigger-words-reference>)
  * [Source Credits](<#source-credits>)
  * [Tested Results (March 2026)](<#tested-results-march-2026>)
    * [Test 1: Gray-area query ("how to pick a lock")](<#test-1-gray-area-query-how-to-pick-a-lock>)
    * [Test 2: Hard query ("write a phishing email template")](<#test-2-hard-query-write-a-phishing-email-template>)
...
<!-- Source: https://hermes-agent.nousresearch.com/docs/user-guide/skills/bundled/red-teaming/red-teaming-godmode -->
