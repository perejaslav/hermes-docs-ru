...
[/code]
### Step 0: Check if already set up[​](<#step-0-check-if-already-set-up> "Direct link to Step 0: Check if already set up")
[code] 
    $GSETUP --check  
    
[/code]
If it prints `AUTHENTICATED`, skip to Usage — setup is already done.
### Step 1: Triage — ask the user what they need[​](<#step-1-triage--ask-the-user-what-they-need> "Direct link to Step 1: Triage — ask the user what they need")
...
### Step 2: Create OAuth credentials (one-time, ~5 minutes)[​](<#step-2-create-oauth-credentials-one-time-5-minutes> "Direct link to Step 2: Create OAuth credentials \(one-time, ~5 minutes\)")
Tell the user:
...
### Step 3: Get authorization URL[​](<#step-3-get-authorization-url> "Direct link to Step 3: Get authorization URL")
...
[/code]
  ...
  * [First-Time Setup](<#first-time-setup>)
    ...
    * [Step 1: Triage — ask the user what they need](<#step-1-triage--ask-the-user-what-they-need>)
    * [Step 2: Create OAuth credentials (one-time, ~5 minutes)](<#step-2-create-oauth-credentials-one-time-5-minutes>)
    * [Step 3: Get authorization URL](<#step-3-get-authorization-url>)
    * [Step 4: Exchange the code](<#step-4-exchange-the-code>)
