...
### 2\. Configure MCP Server[​](<#2-configure-mcp-server> "Direct link to 2. Configure MCP Server")
...
[/code]
### 3\. Restart Hermes[​](<#3-restart-hermes> "Direct link to 3. Restart Hermes")
[code] 
    hermes  
    
[/code]
All 11 AgentMail tools are now available automatically.
## Available Tools (via MCP)[​](<#available-tools-via-mcp> "Direct link to Available Tools \(via MCP\)")
Tool| Description  
---|---  
...
### Create an inbox and send an email[​](<#create-an-inbox-and-send-an-email> "Direct link to Create an inbox and send an email")
...
### Check incoming email[​](<#check-incoming-email> "Direct link to Check incoming email")
...
## References[​](<#references> "Direct link to References")
  ...
  * [Setup](<#setup>)
    ...
    * [3\. Restart Hermes](<#3-restart-hermes>)
  * [Available Tools (via MCP)](<#available-tools-via-mcp>)
  * [Procedure](<#procedure>)
    * [Create an inbox and send an email](<#create-an-inbox-and-send-an-email>)
    * [Check incoming email](<#check-incoming-email>)
