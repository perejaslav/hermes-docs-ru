...
* * *
## ⚠️ Anti-Hallucination Guardrails[​](<#️-anti-hallucination-guardrails> "Direct link to ⚠️ Anti-Hallucination Guardrails")
...
## Phase 0: Initialization[​](<#phase-0-initialization> "Direct link to Phase 0: Initialization")
...
* * *
## Phase 1: Prompt Parsing and IOC Extraction[​](<#phase-1-prompt-parsing-and-ioc-extraction> "Direct link to Phase 1: Prompt Parsing and IOC Extraction")
...
* * *
## Phase 2: Parallel Evidence Collection[​](<#phase-2-parallel-evidence-collection> "Direct link to Phase 2: Parallel Evidence Collection")
...
* * *
### Investigator 1: Local Git Investigator[​](<#investigator-1-local-git-investigator> "Direct link to Investigator 1: Local Git Investigator")
...
* * *
### Investigator 2: GitHub API Investigator[​](<#investigator-2-github-api-investigator> "Direct link to Investigator 2: GitHub API Investigator")
...
* * *
### Investigator 3: Wayback Machine Investigator[​](<#investigator-3-wayback-machine-investigator> "Direct link to Investigator 3: Wayback Machine Investigator")
...
* * *
### Investigator 4: GH Archive / BigQuery Investigator[​](<#investigator-4-gh-archive--bigquery-investigator> "Direct link to Investigator 4: GH Archive / BigQuery Investigator")
...
* * *
### Investigator 5: IOC Enrichment Investigator[​](<#investigator-5-ioc-enrichment-investigator> "Direct link to Investigator 5: IOC Enrichment Investigator")
...
* * *
## Phase 3: Evidence Consolidation[​](<#phase-3-evidence-consolidation> "Direct link to Phase 3: Evidence Consolidation")
...
* * *
## Phase 4: Hypothesis Formation[​](<#phase-4-hypothesis-formation> "Direct link to Phase 4: Hypothesis Formation")
A hypothesis must:
...
* * *
## Phase 5: Hypothesis Validation[​](<#phase-5-hypothesis-validation> "Direct link to Phase 5: Hypothesis Validation")
...
* * *
## Phase 6: Final Report Generation[​](<#phase-6-final-report-generation> "Direct link to Phase 6: Final Report Generation")
...
* * *
## Phase 7: Completion[​](<#phase-7-completion> "Direct link to Phase 7: Completion")
...
* * *
## Ethical Use Guidelines[​](<#ethical-use-guidelines> "Direct link to Ethical Use Guidelines")
...
* * *
## API Rate Limiting[​](<#api-rate-limiting> "Direct link to API Rate Limiting")
...
* * *
## Reference Materials[​](<#reference-materials> "Direct link to Reference Materials")
  ...
  * [⚠️ Anti-Hallucination Guardrails](<#️-anti-hallucination-guardrails>)
  * [Example Scenarios](<#example-scenarios>)
  * [Phase 0: Initialization](<#phase-0-initialization>)
  * [Phase 1: Prompt Parsing and IOC Extraction](<#phase-1-prompt-parsing-and-ioc-extraction>)
  * [Phase 2: Parallel Evidence Collection](<#phase-2-parallel-evidence-collection>)
    * [Investigator 1: Local Git Investigator](<#investigator-1-local-git-investigator>)
    * [Investigator 2: GitHub API Investigator](<#investigator-2-github-api-investigator>)
    * [Investigator 3: Wayback Machine Investigator](<#investigator-3-wayback-machine-investigator>)
    * [Investigator 4: GH Archive / BigQuery Investigator](<#investigator-4-gh-archive--bigquery-investigator>)
    * [Investigator 5: IOC Enrichment Investigator](<#investigator-5-ioc-enrichment-investigator>)
  * [Phase 3: Evidence Consolidation](<#phase-3-evidence-consolidation>)
  * [Phase 4: Hypothesis Formation](<#phase-4-hypothesis-formation>)
  * [Phase 5: Hypothesis Validation](<#phase-5-hypothesis-validation>)
  * [Phase 6: Final Report Generation](<#phase-6-final-report-generation>)
