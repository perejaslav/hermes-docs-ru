...
### Exercise Lookup (wger API)[​](<#exercise-lookup-wger-api> "Direct link to Exercise Lookup \(wger API\)")
...
[/code]
### Nutrition Lookup (USDA FoodData Central)[​](<#nutrition-lookup-usda-fooddata-central> "Direct link to Nutrition Lookup \(USDA FoodData Central\)")
...
[/code]
### Offline Calculators[​](<#offline-calculators> "Direct link to Offline Calculators")
