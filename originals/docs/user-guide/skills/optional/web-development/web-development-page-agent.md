...
## When NOT to use this skill[​](<#when-not-to-use-this-skill> "Direct link to When NOT to use this skill")
  * User wants **Hermes itself to drive a browser** → use Hermes' built-in browser tool (Browserbase / Camofox). page-agent is the _opposite_ direction.
...
## Path 1 — 30-second demo via CDN (no install)[​](<#path-1--30-second-demo-via-cdn-no-install> "Direct link to Path 1 — 30-second demo via CDN \(no install\)")
...
[/code]
## Path 2 — npm install into your own web app (production use)[​](<#path-2--npm-install-into-your-own-web-app-production-use> "Direct link to Path 2 — npm install into your own web app \(production use\)")
...
## Path 3 — clone the source repo (contributing, or hacking on it)[​](<#path-3--clone-the-source-repo-contributing-or-hacking-on-it> "Direct link to Path 3 — clone the source repo \(contributing, or hacking on it\)")
...
## Repo layout (Path 3)[​](<#repo-layout-path-3> "Direct link to Repo layout \(Path 3\)")
...
## Verifying it works[​](<#verifying-it-works> "Direct link to Verifying it works")
...
## Reference[​](<#reference> "Direct link to Reference")
  ...
  * [Path 1 — 30-second demo via CDN (no install)](<#path-1--30-second-demo-via-cdn-no-install>)
  * [Path 2 — npm install into your own web app (production use)](<#path-2--npm-install-into-your-own-web-app-production-use>)
  * [Path 3 — clone the source repo (contributing, or hacking on it)](<#path-3--clone-the-source-repo-contributing-or-hacking-on-it>)
  * [Repo layout (Path 3)](<#repo-layout-path-3>)
