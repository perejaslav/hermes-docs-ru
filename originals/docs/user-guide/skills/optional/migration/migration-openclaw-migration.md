...
## What this skill does[​](<#what-this-skill-does> "Direct link to What this skill does")
...
## Default workflow[​](<#default-workflow> "Direct link to Default workflow")
...
## User interaction protocol[​](<#user-interaction-protocol> "Direct link to User interaction protocol")
...
## Decision-to-command mapping[​](<#decision-to-command-mapping> "Direct link to Decision-to-command mapping")
...
## Post-run reporting rules[​](<#post-run-reporting-rules> "Direct link to Post-run reporting rules")
...
## Migration presets[​](<#migration-presets> "Direct link to Migration presets")
...
After a successful run, the user should have:
  ...
  * [Decision-to-command mapping](<#decision-to-command-mapping>)
  * [Post-run reporting rules](<#post-run-reporting-rules>)
  * [Migration presets](<#migration-presets>)
  * [Commands](<#commands>)
