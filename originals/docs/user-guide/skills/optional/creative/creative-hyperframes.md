...
### 1\. Plan before writing HTML[​](<#1-plan-before-writing-html> "Direct link to 1. Plan before writing HTML")
...
### 2\. Scaffold[​](<#2-scaffold> "Direct link to 2. Scaffold")
[code] 
...
### 3\. Layout before animation[​](<#3-layout-before-animation> "Direct link to 3. Layout before animation")
...
### 4\. Animate with GSAP[​](<#4-animate-with-gsap> "Direct link to 4. Animate with GSAP")
...
### 5\. Transitions between scenes[​](<#5-transitions-between-scenes> "Direct link to 5. Transitions between scenes")
...
### 6\. Audio, captions, TTS, audio-reactive, highlighting[​](<#6-audio-captions-tts-audio-reactive-highlighting> "Direct link to 6. Audio, captions, TTS, audio-reactive, highlighting")
...
### 7\. Lint, validate, inspect, preview, render[​](<#7-lint-validate-inspect-preview-render> "Direct link to 7. Lint, validate, inspect, preview, render")
[code] 
...
### 8\. Website-to-video (if the user gives a URL)[​](<#8-website-to-video-if-the-user-gives-a-url> "Direct link to 8. Website-to-video \(if the user gives a URL\)")
...
## References[​](<#references> "Direct link to References")
  ...
  * [Procedure](<#procedure>)
    * [1\. Plan before writing HTML](<#1-plan-before-writing-html>)
    * [2\. Scaffold](<#2-scaffold>)
    * [3\. Layout before animation](<#3-layout-before-animation>)
    * [4\. Animate with GSAP](<#4-animate-with-gsap>)
    * [5\. Transitions between scenes](<#5-transitions-between-scenes>)
    * [6\. Audio, captions, TTS, audio-reactive, highlighting](<#6-audio-captions-tts-audio-reactive-highlighting>)
    * [7\. Lint, validate, inspect, preview, render](<#7-lint-validate-inspect-preview-render>)
    * [8\. Website-to-video (if the user gives a URL)](<#8-website-to-video-if-the-user-gives-a-url>)
  * [Pitfalls](<#pitfalls>)
