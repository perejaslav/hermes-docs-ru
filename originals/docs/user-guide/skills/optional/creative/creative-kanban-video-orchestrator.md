...
[/code]
### Step 1 — Discover (ask the right questions)[​](<#step-1--discover-ask-the-right-questions> "Direct link to Step 1 — Discover \(ask the right questions\)")
...
### Step 2 — Brief[​](<#step-2--brief> "Direct link to Step 2 — Brief")
...
### Step 3 — Team design[​](<#step-3--team-design> "Direct link to Step 3 — Team design")
...
### Step 4 — Setup[​](<#step-4--setup> "Direct link to Step 4 — Setup")
...
### Step 5 — Execute[​](<#step-5--execute> "Direct link to Step 5 — Execute")
...
### Step 6 — Monitor and intervene[​](<#step-6--monitor-and-intervene> "Direct link to Step 6 — Monitor and intervene")
...
## Reference: worked examples[​](<#reference-worked-examples> "Direct link to Reference: worked examples")
...
## File map[​](<#file-map> "Direct link to File map")
[code] 
...
[/code]
  ...
  * [Workflow](<#workflow>)
    * [Step 1 — Discover (ask the right questions)](<#step-1--discover-ask-the-right-questions>)
    * [Step 2 — Brief](<#step-2--brief>)
    * [Step 3 — Team design](<#step-3--team-design>)
    * [Step 4 — Setup](<#step-4--setup>)
    * [Step 5 — Execute](<#step-5--execute>)
    * [Step 6 — Monitor and intervene](<#step-6--monitor-and-intervene>)
  * [Reference: worked examples](<#reference-worked-examples>)
