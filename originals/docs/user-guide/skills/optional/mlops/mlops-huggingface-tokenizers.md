...
## When to use HuggingFace Tokenizers[​](<#when-to-use-huggingface-tokenizers> "Direct link to When to use HuggingFace Tokenizers")
...
[/code]
### Load pretrained tokenizer[​](<#load-pretrained-tokenizer> "Direct link to Load pretrained tokenizer")
[code] 
...
[/code]
### Train custom BPE tokenizer[​](<#train-custom-bpe-tokenizer> "Direct link to Train custom BPE tokenizer")
[code] 
    from tokenizers import Tokenizer  
...
### Batch encoding with padding[​](<#batch-encoding-with-padding> "Direct link to Batch encoding with padding")
[code] 
    # Enable padding  
...
[/code]
## Tokenization algorithms[​](<#tokenization-algorithms> "Direct link to Tokenization algorithms")
### BPE (Byte-Pair Encoding)[​](<#bpe-byte-pair-encoding> "Direct link to BPE \(Byte-Pair Encoding\)")
**How it works** :
...
### WordPiece[​](<#wordpiece> "Direct link to WordPiece")
**How it works** :
...
### Unigram[​](<#unigram> "Direct link to Unigram")
**How it works** :
...
## Tokenization pipeline[​](<#tokenization-pipeline> "Direct link to Tokenization pipeline")
...
### Pre-tokenization[​](<#pre-tokenization> "Direct link to Pre-tokenization")
...
[/code]
## Alignment tracking[​](<#alignment-tracking> "Direct link to Alignment tracking")
...
## Integration with transformers[​](<#integration-with-transformers> "Direct link to Integration with transformers")
### Load with AutoTokenizer[​](<#load-with-autotokenizer> "Direct link to Load with AutoTokenizer")
[code] 
...
[/code]
### Convert custom tokenizer to transformers[​](<#convert-custom-tokenizer-to-transformers> "Direct link to Convert custom tokenizer to transformers")
[code] 
    from tokenizers import Tokenizer  
...
### Train from iterator (large datasets)[​](<#train-from-iterator-large-datasets> "Direct link to Train from iterator \(large datasets\)")
[code] 
...
### Enable truncation and padding[​](<#enable-truncation-and-padding> "Direct link to Enable truncation and padding")
[code] 
    # Enable truncation  
...
[/code]
### Multi-processing[​](<#multi-processing> "Direct link to Multi-processing")
[code] 
    from tokenizers import Tokenizer  
...
### Training speed[​](<#training-speed> "Direct link to Training speed")
...
### Tokenization speed[​](<#tokenization-speed> "Direct link to Tokenization speed")
...
## Resources[​](<#resources> "Direct link to Resources")
  ...
  * [When to use HuggingFace Tokenizers](<#when-to-use-huggingface-tokenizers>)
  * [Quick start](<#quick-start>)
    * [Installation](<#installation>)
    * [Load pretrained tokenizer](<#load-pretrained-tokenizer>)
    * [Train custom BPE tokenizer](<#train-custom-bpe-tokenizer>)
    * [Batch encoding with padding](<#batch-encoding-with-padding>)
  ...
  * [Alignment tracking](<#alignment-tracking>)
  * [Integration with transformers](<#integration-with-transformers>)
    * [Load with AutoTokenizer](<#load-with-autotokenizer>)
    * [Convert custom tokenizer to transformers](<#convert-custom-tokenizer-to-transformers>)
  * [Common patterns](<#common-patterns>)
    * [Train from iterator (large datasets)](<#train-from-iterator-large-datasets>)
    * [Enable truncation and padding](<#enable-truncation-and-padding>)
    * [Multi-processing](<#multi-processing>)
  * [Performance benchmarks](<#performance-benchmarks>)
    * [Training speed](<#training-speed>)
    * [Tokenization speed](<#tokenization-speed>)
