...
## Resources[​](<#resources> "Direct link to Resources")
  ...
  * [When to use Qdrant](<#when-to-use-qdrant>)
  * [Quick start](<#quick-start>)
    * [Installation](<#installation>)
    * [Basic usage](<#basic-usage>)
  * [Core concepts](<#core-concepts>)
    * [Points - Basic data unit](<#points---basic-data-unit>)
    * [Collections - Vector containers](<#collections---vector-containers>)
  ...
  * [Multi-vector support](<#multi-vector-support>)
    * [Named vectors (different embedding models)](<#named-vectors-different-embedding-models>)
    * [Sparse vectors (BM25, SPLADE)](<#sparse-vectors-bm25-splade>)
