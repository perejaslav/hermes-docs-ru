...
### 1\. Clone and Build GitNexus (one-time setup)[​](<#1-clone-and-build-gitnexus-one-time-setup> "Direct link to 1. Clone and Build GitNexus \(one-time setup\)")
[code] 
...
[/code]
### 2\. Patch the Web UI for Remote Access[​](<#2-patch-the-web-ui-for-remote-access> "Direct link to 2. Patch the Web UI for Remote Access")
...
[/code]
### 3\. Index the Target Repo[​](<#3-index-the-target-repo> "Direct link to 3. Index the Target Repo")
[code] 
...
### 4\. Create the Proxy Script[​](<#4-create-the-proxy-script> "Direct link to 4. Create the Proxy Script")
...
[/code]
### 5\. Start the Services[​](<#5-start-the-services> "Direct link to 5. Start the Services")
[code] 
...
### 6\. Tunnel with Cloudflare (optional — for remote access)[​](<#6-tunnel-with-cloudflare-optional--for-remote-access> "Direct link to 6. Tunnel with Cloudflare \(optional — for remote access\)")
[code] 
...
### 7\. Cleanup[​](<#7-cleanup> "Direct link to 7. Cleanup")
[code] 
    # Stop services  
...
## Pitfalls[​](<#pitfalls> "Direct link to Pitfalls")
  ...
  * [Steps](<#steps>)
    * [1\. Clone and Build GitNexus (one-time setup)](<#1-clone-and-build-gitnexus-one-time-setup>)
    ...
    * [6\. Tunnel with Cloudflare (optional — for remote access)](<#6-tunnel-with-cloudflare-optional--for-remote-access>)
    * [7\. Cleanup](<#7-cleanup>)
  * [Pitfalls](<#pitfalls>)
