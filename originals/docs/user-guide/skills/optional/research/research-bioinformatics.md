...
## How to fetch and use a skill[​](<#how-to-fetch-and-use-a-skill> "Direct link to How to fetch and use a skill")
  1. Identify the domain and skill name from the index below.
  2. Clone the relevant repo (shallow clone to save time):
[code] # bioSkills (reference material)  
...
[code] # bioSkills — each skill is at: <category>/<skill-name>/SKILL.md  
...
## Skill Index by Domain[​](<#skill-index-by-domain> "Direct link to Skill Index by Domain")
### Sequence Fundamentals[​](<#sequence-fundamentals> "Direct link to Sequence Fundamentals")
...
### Read QC & Alignment[​](<#read-qc--alignment> "Direct link to Read QC & Alignment")
...
### Variant Calling & Annotation[​](<#variant-calling--annotation> "Direct link to Variant Calling & Annotation")
...
### Differential Expression (Bulk RNA-seq)[​](<#differential-expression-bulk-rna-seq> "Direct link to Differential Expression \(Bulk RNA-seq\)")
...
### Single-Cell RNA-seq[​](<#single-cell-rna-seq> "Direct link to Single-Cell RNA-seq")
...
### Spatial Transcriptomics[​](<#spatial-transcriptomics> "Direct link to Spatial Transcriptomics")
...
### Epigenomics[​](<#epigenomics> "Direct link to Epigenomics")
...
### Pharmacogenomics & Clinical[​](<#pharmacogenomics--clinical> "Direct link to Pharmacogenomics & Clinical")
...
### Population Genetics & GWAS[​](<#population-genetics--gwas> "Direct link to Population Genetics & GWAS")
...
### Metagenomics & Microbiome[​](<#metagenomics--microbiome> "Direct link to Metagenomics & Microbiome")
...
### Genome Assembly & Annotation[​](<#genome-assembly--annotation> "Direct link to Genome Assembly & Annotation")
...
### Structural Biology & Chemoinformatics[​](<#structural-biology--chemoinformatics> "Direct link to Structural Biology & Chemoinformatics")
...
### Proteomics[​](<#proteomics> "Direct link to Proteomics")
...
### Pathway Analysis & Gene Networks[​](<#pathway-analysis--gene-networks> "Direct link to Pathway Analysis & Gene Networks")
...
### Immunoinformatics[​](<#immunoinformatics> "Direct link to Immunoinformatics")
...
### CRISPR & Genome Engineering[​](<#crispr--genome-engineering> "Direct link to CRISPR & Genome Engineering")
...
### Workflow Management[​](<#workflow-management> "Direct link to Workflow Management")
...
### Specialized Domains[​](<#specialized-domains> "Direct link to Specialized Domains")
...
### Data Visualization & Reporting[​](<#data-visualization--reporting> "Direct link to Data Visualization & Reporting")
...
### Database Access[​](<#database-access> "Direct link to Database Access")
...
### Experimental Design[​](<#experimental-design> "Direct link to Experimental Design")
bioSkills: experimental-design/ — power-analysis, sample-size, batch-design, multiple-testing
### Machine Learning for Omics[​](<#machine-learning-for-omics> "Direct link to Machine Learning for Omics")
...
## Pitfalls[​](<#pitfalls> "Direct link to Pitfalls")
  ...
  * [Sources](<#sources>)
  * [How to fetch and use a skill](<#how-to-fetch-and-use-a-skill>)
  * [Skill Index by Domain](<#skill-index-by-domain>)
    * [Sequence Fundamentals](<#sequence-fundamentals>)
    * [Read QC & Alignment](<#read-qc--alignment>)
    * [Variant Calling & Annotation](<#variant-calling--annotation>)
    * [Differential Expression (Bulk RNA-seq)](<#differential-expression-bulk-rna-seq>)
    * [Single-Cell RNA-seq](<#single-cell-rna-seq>)
    * [Spatial Transcriptomics](<#spatial-transcriptomics>)
    * [Epigenomics](<#epigenomics>)
    * [Pharmacogenomics & Clinical](<#pharmacogenomics--clinical>)
    * [Population Genetics & GWAS](<#population-genetics--gwas>)
    * [Metagenomics & Microbiome](<#metagenomics--microbiome>)
    * [Genome Assembly & Annotation](<#genome-assembly--annotation>)
    * [Structural Biology & Chemoinformatics](<#structural-biology--chemoinformatics>)
    * [Proteomics](<#proteomics>)
    * [Pathway Analysis & Gene Networks](<#pathway-analysis--gene-networks>)
    * [Immunoinformatics](<#immunoinformatics>)
    * [CRISPR & Genome Engineering](<#crispr--genome-engineering>)
    * [Workflow Management](<#workflow-management>)
    * [Specialized Domains](<#specialized-domains>)
    * [Data Visualization & Reporting](<#data-visualization--reporting>)
    * [Database Access](<#database-access>)
    * [Experimental Design](<#experimental-design>)
    * [Machine Learning for Omics](<#machine-learning-for-omics>)
