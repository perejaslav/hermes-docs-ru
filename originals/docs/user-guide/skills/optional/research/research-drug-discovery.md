...
## Core Workflows[​](<#core-workflows> "Direct link to Core Workflows")
### 1 — Bioactive Compound Search (ChEMBL)[​](<#1--bioactive-compound-search-chembl> "Direct link to 1 — Bioactive Compound Search \(ChEMBL\)")
...
[/code]
### 2 — Drug-Likeness Calculation (Lipinski Ro5 + Veber)[​](<#2--drug-likeness-calculation-lipinski-ro5--veber> "Direct link to 2 — Drug-Likeness Calculation \(Lipinski Ro5 + Veber\)")
...
[/code]
### 3 — Drug Interaction & Safety Lookup (OpenFDA)[​](<#3--drug-interaction--safety-lookup-openfda> "Direct link to 3 — Drug Interaction & Safety Lookup \(OpenFDA\)")
[code] 
    DRUG="$1"  
...
[/code]
### 4 — PubChem Compound Search[​](<#4--pubchem-compound-search> "Direct link to 4 — PubChem Compound Search")
[code] 
    COMPOUND="$1"  
    ENCODED=$(python3 -c "import urllib.parse,sys; print(urllib.parse.quote(sys.argv[1]))" "$COMPOUND")  
...
[/code]
### 5 — Target & Disease Literature (OpenTargets)[​](<#5--target--disease-literature-opentargets> "Direct link to 5 — Target & Disease Literature \(OpenTargets\)")
[code] 
    GENE="$1"  
...
[/code]
## Reasoning Guidelines[​](<#reasoning-guidelines> "Direct link to Reasoning Guidelines")
...
Gene-disease| OpenTargets| GraphQL POST `/api/v4/graphql`  
  ...
  * [Core Workflows](<#core-workflows>)
    * [1 — Bioactive Compound Search (ChEMBL)](<#1--bioactive-compound-search-chembl>)
    * [2 — Drug-Likeness Calculation (Lipinski Ro5 + Veber)](<#2--drug-likeness-calculation-lipinski-ro5--veber>)
    * [3 — Drug Interaction & Safety Lookup (OpenFDA)](<#3--drug-interaction--safety-lookup-openfda>)
    * [4 — PubChem Compound Search](<#4--pubchem-compound-search>)
    * [5 — Target & Disease Literature (OpenTargets)](<#5--target--disease-literature-opentargets>)
