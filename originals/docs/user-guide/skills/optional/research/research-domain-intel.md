...
## When to use this vs built-in tools[​](<#when-to-use-this-vs-built-in-tools> "Direct link to When to use this vs built-in tools")
...
* * *
_Contributed by[@FurkanL0](<https://github.com/FurkanL0>)_
  * [Skill metadata](<#skill-metadata>)
  * [Reference: full SKILL.md](<#reference-full-skillmd>)
  * [Helper script](<#helper-script>)
  * [Available commands](<#available-commands>)
  * [When to use this vs built-in tools](<#when-to-use-this-vs-built-in-tools>)
