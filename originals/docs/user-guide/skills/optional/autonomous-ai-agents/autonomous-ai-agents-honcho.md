...
`hermes memory off`| Disable external memory provider  
  ...
  * [Setup](<#setup>)
    * [Cloud (app.honcho.dev)](<#cloud-apphonchodev>)
    * [Self-hosted](<#self-hosted>)
    * [Verify](<#verify>)
  * [Architecture](<#architecture>)
    * [Base Context Injection](<#base-context-injection>)
    * [Cold / Warm Prompt Selection](<#cold--warm-prompt-selection>)
    * [Peers](<#peers>)
    * [Observation](<#observation>)
    * [Sessions](<#sessions>)
    * [Recall Modes](<#recall-modes>)
  * [Three Orthogonal Knobs](<#three-orthogonal-knobs>)
    * [Cadence (when)](<#cadence-when>)
    * [Depth (how many)](<#depth-how-many>)
    * [Level (how hard)](<#level-how-hard>)
  * [Multi-Profile Setup](<#multi-profile-setup>)
    * [Create a profile with Honcho peer](<#create-a-profile-with-honcho-peer>)
    * [Backfill existing profiles](<#backfill-existing-profiles>)
    * [Per-profile config](<#per-profile-config>)
  * [Tools](<#tools>)
    ...
    * [Bidirectional peer targeting](<#bidirectional-peer-targeting>)
  * [Agent Usage Patterns](<#agent-usage-patterns>)
    * [On conversation start](<#on-conversation-start>)
    * [When the user shares something to remember](<#when-the-user-shares-something-to-remember>)
    * [When the user asks about past context / you need to recall specifics](<#when-the-user-asks-about-past-context--you-need-to-recall-specifics>)
    * [When to use `peer: "ai"`](<#when-to-use-peer-ai>)
    * [When NOT to call tools](<#when-not-to-call-tools>)
    * [Cadence awareness](<#cadence-awareness>)
  * [Config Reference](<#config-reference>)
    * [Key settings](<#key-settings>)
    * [Dialectic settings](<#dialectic-settings>)
    * [Context budget and injection](<#context-budget-and-injection>)
    * [Memory-context sanitization](<#memory-context-sanitization>)
  * [Troubleshooting](<#troubleshooting>)
    * ["Honcho not configured"](<#honcho-not-configured>)
    * [Memory not persisting across sessions](<#memory-not-persisting-across-sessions>)
    * [Profile not getting its own peer](<#profile-not-getting-its-own-peer>)
    * [Observation changes in dashboard not reflected](<#observation-changes-in-dashboard-not-reflected>)
    * [Messages truncated](<#messages-truncated>)
    * [Context injection too large](<#context-injection-too-large>)
    * [Session summary missing](<#session-summary-missing>)
