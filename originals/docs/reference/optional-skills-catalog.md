...
Skill| Description  
---|---  
[**agentmail**](</docs/user-guide/skills/optional/email/email-agentmail>)|  Give the agent its own dedicated email inbox via AgentMail. Send, receive, and manage email autonomously using agent-owned email addresses (e.g. [hermes-agent@agentmail.to](<mailto:hermes-agent@agentmail.to>)).  
...
## web-development[​](<#web-development> "Direct link to web-development")
Skill| Description  
---|---  
...
* * *
## Contributing Optional Skills[​](<#contributing-optional-skills> "Direct link to Contributing Optional Skills")
To add a new optional skill to the repository:
  ...
  * [Contributing Optional Skills](<#contributing-optional-skills>)
