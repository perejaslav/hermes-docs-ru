...
## Interactive CLI slash commands[​](<#interactive-cli-slash-commands> "Direct link to Interactive CLI slash commands")
...
### Dynamic CLI slash commands[​](<#dynamic-cli-slash-commands> "Direct link to Dynamic CLI slash commands")
Command| Description  
---|---  
...
### Custom model aliases[​](<#custom-model-aliases> "Direct link to Custom model aliases")
...
### Alias Resolution[​](<#alias-resolution> "Direct link to Alias Resolution")
...
## Messaging slash commands[​](<#messaging-slash-commands> "Direct link to Messaging slash commands")
...
## Notes[​](<#notes> "Direct link to Notes")
  ...
  * [Interactive CLI slash commands](<#interactive-cli-slash-commands>)
    ...
    * [Info](<#info>)
    * [Exit](<#exit>)
    * [Dynamic CLI slash commands](<#dynamic-cli-slash-commands>)
    * [Quick Commands](<#quick-commands>)
    * [Custom model aliases](<#custom-model-aliases>)
    * [Alias Resolution](<#alias-resolution>)
  * [Messaging slash commands](<#messaging-slash-commands>)
  * [Notes](<#notes>)
