...
## `tools` policy keys[​](<#tools-policy-keys> "Direct link to tools-policy-keys")
Key| Type| Meaning  
---|---|---  
...
## Utility-tool policy[​](<#utility-tool-policy> "Direct link to Utility-tool policy")
...
[/code]
## Tool naming[​](<#tool-naming> "Direct link to Tool naming")
...
Behavior:
  ...
  * [Root config shape](<#root-config-shape>)
  * [Server keys](<#server-keys>)
  * [`tools` policy keys](<#tools-policy-keys>)
  * [Filtering semantics](<#filtering-semantics>)
    * [`include`](<#include>)
    * [`exclude`](<#exclude>)
    * [Precedence](<#precedence>)
  * [Utility-tool policy](<#utility-tool-policy>)
    * [Disable resources](<#disable-resources>)
    * [Disable prompts](<#disable-prompts>)
    * [Capability-aware registration](<#capability-aware-registration>)
  * [`enabled: false`](<#enabled-false>)
  * [Empty result behavior](<#empty-result-behavior>)
  * [Example configs](<#example-configs>)
    * [Safe GitHub allowlist](<#safe-github-allowlist>)
    * [Stripe blacklist](<#stripe-blacklist>)
    * [Resource-only docs server](<#resource-only-docs-server>)
