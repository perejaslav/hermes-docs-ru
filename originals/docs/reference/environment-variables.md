...
## LLM Providers[​](<#llm-providers> "Direct link to LLM Providers")
...
## Provider Auth (OAuth)[​](<#provider-auth-oauth> "Direct link to Provider Auth \(OAuth\)")
...
## Tool APIs[​](<#tool-apis> "Direct link to Tool APIs")
Variable| Description  
---|---  
...
## Terminal Backend[​](<#terminal-backend> "Direct link to Terminal Backend")
Variable| Description  
---|---  
...
## Container Resources (Docker, Singularity, Modal, Daytona)[​](<#container-resources-docker-singularity-modal-daytona> "Direct link to Container Resources \(Docker, Singularity, Modal, Daytona\)")
Variable| Description  
---|---  
...
`DISCORD_ALLOW_MENTION_EVERYONE`| Allow the bot to ping `@everyone`/`@here` (default: `false`). See [Mention Control](</docs/user-guide/messaging/discord#mention-control>).  
...
`FEISHU_ALLOW_BOTS`| `none` (default) / `mentions` / `all` — accept inbound messages from other bots. See [bot-to-bot messaging](</docs/user-guide/messaging/feishu#bot-to-bot-messaging>)  
...
### Advanced Messaging Tuning[​](<#advanced-messaging-tuning> "Direct link to Advanced Messaging Tuning")
...
Variable| Description  
---|---  
`HERMES_TUI`| Launch the [TUI](</docs/user-guide/tui>) instead of the classic CLI when set to `1`. Equivalent to passing `--tui`.  
...
## Session Settings[​](<#session-settings> "Direct link to Session Settings")
Variable| Description  
---|---  
...
## Context Compression (config.yaml only)[​](<#context-compression-configyaml-only> "Direct link to Context Compression \(config.yaml only\)")
...
## Auxiliary Task Overrides[​](<#auxiliary-task-overrides> "Direct link to Auxiliary Task Overrides")
Variable| Description  
---|---  
...
## Fallback Providers (config.yaml only)[​](<#fallback-providers-configyaml-only> "Direct link to Fallback Providers \(config.yaml only\)")
...
## Provider Routing (config.yaml only)[​](<#provider-routing-configyaml-only> "Direct link to Provider Routing \(config.yaml only\)")
...
Use `hermes config set` to set environment variables — it automatically saves them to the right file (`.env` for secrets, `config.yaml` for everything else).
  ...
  * [Container Resources (Docker, Singularity, Modal, Daytona)](<#container-resources-docker-singularity-modal-daytona>)
  * [Persistent Shell](<#persistent-shell>)
  * [Messaging](<#messaging>)
    * [Advanced Messaging Tuning](<#advanced-messaging-tuning>)
  * [Agent Behavior](<#agent-behavior>)
  * [Interface](<#interface>)
  * [Session Settings](<#session-settings>)
  * [Context Compression (config.yaml only)](<#context-compression-configyaml-only>)
  * [Auxiliary Task Overrides](<#auxiliary-task-overrides>)
  * [Fallback Providers (config.yaml only)](<#fallback-providers-configyaml-only>)
  * [Provider Routing (config.yaml only)](<#provider-routing-configyaml-only>)
