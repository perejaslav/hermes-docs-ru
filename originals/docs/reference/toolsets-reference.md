...
## How Toolsets Work[​](<#how-toolsets-work> "Direct link to How Toolsets Work")
...
## Configuring Toolsets[​](<#configuring-toolsets> "Direct link to Configuring Toolsets")
### Per-session (CLI)[​](<#per-session-cli> "Direct link to Per-session \(CLI\)")
[code] 
...
[/code]
### Per-platform (config.yaml)[​](<#per-platform-configyaml> "Direct link to Per-platform \(config.yaml\)")
[code] 
    toolsets:  
...
[/code]
### Interactive management[​](<#interactive-management> "Direct link to Interactive management")
[code] 
...
[/code]
## Core Toolsets[​](<#core-toolsets> "Direct link to Core Toolsets")
...
## Platform Toolsets[​](<#platform-toolsets> "Direct link to Platform Toolsets")
...
## Dynamic Toolsets[​](<#dynamic-toolsets> "Direct link to Dynamic Toolsets")
### MCP server toolsets[​](<#mcp-server-toolsets> "Direct link to MCP server toolsets")
...
### Plugin toolsets[​](<#plugin-toolsets> "Direct link to Plugin toolsets")
...
### Custom toolsets[​](<#custom-toolsets> "Direct link to Custom toolsets")
...
## Relationship to `hermes tools`[​](<#relationship-to-hermes-tools> "Direct link to relationship-to-hermes-tools")
...
See also: [Tools Reference](</docs/reference/tools-reference>) for the complete list of individual tools and their parameters.
  * [How Toolsets Work](<#how-toolsets-work>)
  * [Configuring Toolsets](<#configuring-toolsets>)
    * [Per-session (CLI)](<#per-session-cli>)
    * [Per-platform (config.yaml)](<#per-platform-configyaml>)
    * [Interactive management](<#interactive-management>)
  * [Core Toolsets](<#core-toolsets>)
  * [Platform Toolsets](<#platform-toolsets>)
  * [Dynamic Toolsets](<#dynamic-toolsets>)
    * [MCP server toolsets](<#mcp-server-toolsets>)
    * [Plugin toolsets](<#plugin-toolsets>)
    * [Custom toolsets](<#custom-toolsets>)
    * [Wildcards](<#wildcards>)
  * [Relationship to `hermes tools`](<#relationship-to-hermes-tools>)
