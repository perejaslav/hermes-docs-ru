...
[/code]
### `hermes -z <prompt>` — scripted one-shot[​](<#hermes--z-prompt--scripted-one-shot> "Direct link to hermes--z-prompt--scripted-one-shot")
...
## `hermes slack`[​](<#hermes-slack> "Direct link to hermes-slack")
[code] 
...
## `hermes login` / `hermes logout` _(Deprecated)_[​](<#hermes-login--hermes-logout-deprecated> "Direct link to hermes-login--hermes-logout-deprecated")
caution
...
## `hermes kanban`[​](<#hermes-kanban> "Direct link to hermes-kanban")
[code] 
...
[/code]
## `hermes checkpoints`[​](<#hermes-checkpoints> "Direct link to hermes-checkpoints")
[code] 
...
[/code]
See [Checkpoints and `/rollback`](</docs/user-guide/checkpoints-and-rollback>) for the full architecture and the in-session commands.
...
## `hermes curator`[​](<#hermes-curator> "Direct link to hermes-curator")
[code] 
...
## `hermes fallback`[​](<#hermes-fallback> "Direct link to hermes-fallback")
[code] 
...
See [Fallback Providers](</docs/user-guide/features/fallback-providers>).
## `hermes hooks`[​](<#hermes-hooks> "Direct link to hermes-hooks")
[code] 
...
See [Hooks](</docs/user-guide/features/hooks>) for event signatures and payload shapes.
...
## `hermes tools`[​](<#hermes-tools> "Direct link to hermes-tools")
[code] 
...
[/code]
## `hermes update`[​](<#hermes-update> "Direct link to hermes-update")
[code] 
...
## `hermes fallback`[​](<#hermes-fallback-1> "Direct link to hermes-fallback-1")
[code] 
...
All changes persist to the top-level `fallback_providers:` list in `config.yaml`. Interacts with [Credential Pools](</docs/user-guide/features/credential-pools>): pools rotate keys _within_ a provider, fallbacks switch to a _different_ provider entirely.
...
## See also[​](<#see-also> "Direct link to See also")
  ...
  * [Global entrypoint](<#global-entrypoint>)
    * [Global options](<#global-options>)
  * [Top-level commands](<#top-level-commands>)
  * [`hermes chat`](<#hermes-chat>)
    * [`hermes -z <prompt>` — scripted one-shot](<#hermes--z-prompt--scripted-one-shot>)
  * [`hermes model`](<#hermes-model>)
    * [`/model` slash command (mid-session)](<#model-slash-command-mid-session>)
  * [`hermes gateway`](<#hermes-gateway>)
  * [`hermes setup`](<#hermes-setup>)
  * [`hermes whatsapp`](<#hermes-whatsapp>)
  * [`hermes slack`](<#hermes-slack>)
  * [`hermes login` / `hermes logout` _(Deprecated)_](<#hermes-login--hermes-logout-deprecated>)
