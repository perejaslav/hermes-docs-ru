...
### Nightly Backlog Triage[​](<#nightly-backlog-triage> "Direct link to Nightly Backlog Triage")
...
[/code]
### Automatic PR Code Review[​](<#automatic-pr-code-review> "Direct link to Automatic PR Code Review")
...
### Docs Drift Detection[​](<#docs-drift-detection> "Direct link to Docs Drift Detection")
...
[/code]
### Dependency Security Audit[​](<#dependency-security-audit> "Direct link to Dependency Security Audit")
...
[/code]
* * *
## DevOps & Monitoring[​](<#devops--monitoring> "Direct link to DevOps & Monitoring")
### Deploy Verification[​](<#deploy-verification> "Direct link to Deploy Verification")
...
[/code]
### Alert Triage[​](<#alert-triage> "Direct link to Alert Triage")
...
[/code]
### Uptime Monitor[​](<#uptime-monitor> "Direct link to Uptime Monitor")
...
[/code]
* * *
## Research & Intelligence[​](<#research--intelligence> "Direct link to Research & Intelligence")
### Competitive Repository Scout[​](<#competitive-repository-scout> "Direct link to Competitive Repository Scout")
...
[/code]
### AI News Digest[​](<#ai-news-digest> "Direct link to AI News Digest")
...
[/code]
### Paper Digest with Notes[​](<#paper-digest-with-notes> "Direct link to Paper Digest with Notes")
...
[/code]
* * *
## GitHub Event Automations[​](<#github-event-automations> "Direct link to GitHub Event Automations")
### Issue Auto-Labeling[​](<#issue-auto-labeling> "Direct link to Issue Auto-Labeling")
...
[/code]
### CI Failure Analysis[​](<#ci-failure-analysis> "Direct link to CI Failure Analysis")
...
[/code]
### Auto-Port Changes Across Repos[​](<#auto-port-changes-across-repos> "Direct link to Auto-Port Changes Across Repos")
...
[/code]
* * *
## Business Operations[​](<#business-operations> "Direct link to Business Operations")
### Stripe Payment Monitoring[​](<#stripe-payment-monitoring> "Direct link to Stripe Payment Monitoring")
...
[/code]
### Daily Revenue Summary[​](<#daily-revenue-summary> "Direct link to Daily Revenue Summary")
...
[/code]
* * *
## Multi-Skill Workflows[​](<#multi-skill-workflows> "Direct link to Multi-Skill Workflows")
### Security Audit Pipeline[​](<#security-audit-pipeline> "Direct link to Security Audit Pipeline")
...
[/code]
### Content Pipeline[​](<#content-pipeline> "Direct link to Content Pipeline")
...
### Cron Schedule Syntax[​](<#cron-schedule-syntax> "Direct link to Cron Schedule Syntax")
Expression| Meaning  
---|---  
...
`0 */6 * * *`| Every 6 hours  
### Delivery Targets[​](<#delivery-targets> "Direct link to Delivery Targets")
Target| Flag| Notes  
---|---|---  
...
### Webhook Template Variables[​](<#webhook-template-variables> "Direct link to Webhook Template Variables")
...
### The [SILENT] Pattern[​](<#the-silent-pattern> "Direct link to The \[SILENT\] Pattern")
...
This means you only get notified when the agent has something to report.
  * [Development Workflow](<#development-workflow>)
    * [Nightly Backlog Triage](<#nightly-backlog-triage>)
    * [Automatic PR Code Review](<#automatic-pr-code-review>)
    * [Docs Drift Detection](<#docs-drift-detection>)
  ...
  * [Research & Intelligence](<#research--intelligence>)
    * [Competitive Repository Scout](<#competitive-repository-scout>)
    * [AI News Digest](<#ai-news-digest>)
    * [Paper Digest with Notes](<#paper-digest-with-notes>)
  * [GitHub Event Automations](<#github-event-automations>)
    * [Issue Auto-Labeling](<#issue-auto-labeling>)
    * [CI Failure Analysis](<#ci-failure-analysis>)
    * [Auto-Port Changes Across Repos](<#auto-port-changes-across-repos>)
  * [Business Operations](<#business-operations>)
    * [Stripe Payment Monitoring](<#stripe-payment-monitoring>)
    * [Daily Revenue Summary](<#daily-revenue-summary>)
  * [Multi-Skill Workflows](<#multi-skill-workflows>)
    * [Security Audit Pipeline](<#security-audit-pipeline>)
    * [Content Pipeline](<#content-pipeline>)
  * [Quick Reference](<#quick-reference>)
    * [Cron Schedule Syntax](<#cron-schedule-syntax>)
    * [Delivery Targets](<#delivery-targets>)
    * [Webhook Template Variables](<#webhook-template-variables>)
    * [The [SILENT] Pattern](<#the-silent-pattern>)
