...
* * *
## Pattern 1: Website Change Monitor[​](<#pattern-1-website-change-monitor> "Direct link to Pattern 1: Website Change Monitor")
...
* * *
## Pattern 2: Weekly Report[​](<#pattern-2-weekly-report> "Direct link to Pattern 2: Weekly Report")
...
* * *
## Pattern 3: GitHub Repository Watcher[​](<#pattern-3-github-repository-watcher> "Direct link to Pattern 3: GitHub Repository Watcher")
...
* * *
## Pattern 4: Data Collection Pipeline[​](<#pattern-4-data-collection-pipeline> "Direct link to Pattern 4: Data Collection Pipeline")
...
* * *
## Pattern 5: Multi-Skill Workflow[​](<#pattern-5-multi-skill-workflow> "Direct link to Pattern 5: Multi-Skill Workflow")
...
* * *
## Managing Your Jobs[​](<#managing-your-jobs> "Direct link to Managing Your Jobs")
[code] 
...
* * *
_For the complete cron reference — all parameters, edge cases, and internals — see[Scheduled Tasks (Cron)](</docs/user-guide/features/cron>)._
  * [Pattern 1: Website Change Monitor](<#pattern-1-website-change-monitor>)
  * [Pattern 2: Weekly Report](<#pattern-2-weekly-report>)
  * [Pattern 3: GitHub Repository Watcher](<#pattern-3-github-repository-watcher>)
  * [Pattern 4: Data Collection Pipeline](<#pattern-4-data-collection-pipeline>)
  * [Pattern 5: Multi-Skill Workflow](<#pattern-5-multi-skill-workflow>)
