...
## Configuration (written to `config.yaml`)[​](<#configuration-written-to-configyaml> "Direct link to configuration-written-to-configyaml")
...
[/code]
## OpenAI-style endpoints (GPT, Llama, etc.)[​](<#openai-style-endpoints-gpt-llama-etc> "Direct link to OpenAI-style endpoints \(GPT, Llama, etc.\)")
...
## Anthropic-style endpoints (Claude via Azure Foundry)[​](<#anthropic-style-endpoints-claude-via-azure-foundry> "Direct link to Anthropic-style endpoints \(Claude via Azure Foundry\)")
...
## Alternative: `provider: anthropic` \+ Azure base URL[​](<#alternative-provider-anthropic--azure-base-url> "Direct link to alternative-provider-anthropic--azure-base-url")
...
## Related[​](<#related> "Direct link to Related")
  ...
  * [Configuration (written to `config.yaml`)](<#configuration-written-to-configyaml>)
  * [OpenAI-style endpoints (GPT, Llama, etc.)](<#openai-style-endpoints-gpt-llama-etc>)
  * [Anthropic-style endpoints (Claude via Azure Foundry)](<#anthropic-style-endpoints-claude-via-azure-foundry>)
  * [Alternative: `provider: anthropic` \+ Azure base URL](<#alternative-provider-anthropic--azure-base-url>)
