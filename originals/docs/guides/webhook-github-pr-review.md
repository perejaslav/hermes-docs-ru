...
If you don't have a public URL or just want to get started quickly, check out [Build a GitHub PR Review Agent](</docs/guides/github-pr-review-agent>) — uses cron jobs to poll for PRs on a schedule, works behind NAT and firewalls.
Reference docs
...
* * *
## Step 1 — Enable the webhook platform[​](<#step-1--enable-the-webhook-platform> "Direct link to Step 1 — Enable the webhook platform")
...
* * *
## Step 2 — Start the gateway[​](<#step-2--start-the-gateway> "Direct link to Step 2 — Start the gateway")
[code] 
    hermes gateway  
...
[/code]
* * *
## Step 3 — Register the webhook on GitHub[​](<#step-3--register-the-webhook-on-github> "Direct link to Step 3 — Register the webhook on GitHub")
...
* * *
## Step 4 — Open a test PR[​](<#step-4--open-a-test-pr> "Direct link to Step 4 — Open a test PR")
...
* * *
## Filtering to specific actions[​](<#filtering-to-specific-actions> "Direct link to Filtering to specific actions")
...
* * *
## Using a skill for consistent review style[​](<#using-a-skill-for-consistent-review-style> "Direct link to Using a skill for consistent review style")
...
* * *
## Sending responses to Slack or Discord instead[​](<#sending-responses-to-slack-or-discord-instead> "Direct link to Sending responses to Slack or Discord instead")
...
* * *
## GitLab support[​](<#gitlab-support> "Direct link to GitLab support")
...
## What's Next?[​](<#whats-next> "Direct link to What's Next?")
  * **[Cron-Based PR Reviews](</docs/guides/github-pr-review-agent>)** — poll for PRs on a schedule, no public endpoint needed
  ...
  * [Step 1 — Enable the webhook platform](<#step-1--enable-the-webhook-platform>)
  * [Step 2 — Start the gateway](<#step-2--start-the-gateway>)
  * [Step 3 — Register the webhook on GitHub](<#step-3--register-the-webhook-on-github>)
  * [Step 4 — Open a test PR](<#step-4--open-a-test-pr>)
  * [Local testing with ngrok](<#local-testing-with-ngrok>)
  * [Filtering to specific actions](<#filtering-to-specific-actions>)
  * [Using a skill for consistent review style](<#using-a-skill-for-consistent-review-style>)
  * [Sending responses to Slack or Discord instead](<#sending-responses-to-slack-or-discord-instead>)
