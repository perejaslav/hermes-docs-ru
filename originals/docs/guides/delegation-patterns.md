...
* * *
## When to Delegate[​](<#when-to-delegate> "Direct link to When to Delegate")
...
* * *
## Pattern: Parallel Research[​](<#pattern-parallel-research> "Direct link to Pattern: Parallel Research")
...
* * *
## Pattern: Code Review[​](<#pattern-code-review> "Direct link to Pattern: Code Review")
...
* * *
## Pattern: Compare Alternatives[​](<#pattern-compare-alternatives> "Direct link to Pattern: Compare Alternatives")
...
* * *
## Pattern: Multi-File Refactoring[​](<#pattern-multi-file-refactoring> "Direct link to Pattern: Multi-File Refactoring")
...
* * *
## Pattern: Gather Then Analyze[​](<#pattern-gather-then-analyze> "Direct link to Pattern: Gather Then Analyze")
...
* * *
## Toolset Selection[​](<#toolset-selection> "Direct link to Toolset Selection")
...
### Tuning Concurrency and Depth[​](<#tuning-concurrency-and-depth> "Direct link to Tuning Concurrency and Depth")
...
* * *
_For the complete delegation reference — all parameters, ACP integration, and advanced configuration — see[Subagent Delegation](</docs/user-guide/features/delegation>)._
  * [When to Delegate](<#when-to-delegate>)
  * [Pattern: Parallel Research](<#pattern-parallel-research>)
  * [Pattern: Code Review](<#pattern-code-review>)
  * [Pattern: Compare Alternatives](<#pattern-compare-alternatives>)
  * [Pattern: Multi-File Refactoring](<#pattern-multi-file-refactoring>)
  * [Pattern: Gather Then Analyze](<#pattern-gather-then-analyze>)
  * [Toolset Selection](<#toolset-selection>)
  * [Constraints](<#constraints>)
    * [Tuning Concurrency and Depth](<#tuning-concurrency-and-depth>)
  * [Tips](<#tips>)
