...
### Persona, memory, and instructions[​](<#persona-memory-and-instructions> "Direct link to Persona, memory, and instructions")
...
### Skills (4 sources)[​](<#skills-4-sources> "Direct link to Skills \(4 sources\)")
...
### Model and provider configuration[​](<#model-and-provider-configuration> "Direct link to Model and provider configuration")
...
### TTS (text-to-speech)[​](<#tts-text-to-speech> "Direct link to TTS \(text-to-speech\)")
...
### Other config[​](<#other-config> "Direct link to Other config")
...
### Archived (no direct Hermes equivalent)[​](<#archived-no-direct-hermes-equivalent> "Direct link to Archived \(no direct Hermes equivalent\)")
...
## API key resolution[​](<#api-key-resolution> "Direct link to API key resolution")
...
### Supported key targets[​](<#supported-key-targets> "Direct link to Supported key targets")
`OPENROUTER_API_KEY`, `OPENAI_API_KEY`, `ANTHROPIC_API_KEY`, `DEEPSEEK_API_KEY`, `GEMINI_API_KEY`, `ZAI_API_KEY`, `MINIMAX_API_KEY`, `ELEVENLABS_API_KEY`, `TELEGRAM_BOT_TOKEN`, `VOICE_TOOLS_OPENAI_KEY`
Keys not in this allowlist are never copied.
## SecretRef handling[​](<#secretref-handling> "Direct link to SecretRef handling")
...
## After migration[​](<#after-migration> "Direct link to After migration")
...
### "OpenClaw directory not found"[​](<#openclaw-directory-not-found> "Direct link to "OpenClaw directory not found"")
...
### "No provider API keys found"[​](<#no-provider-api-keys-found> "Direct link to "No provider API keys found"")
...
### Skills not appearing after migration[​](<#skills-not-appearing-after-migration> "Direct link to Skills not appearing after migration")
...
### TTS voice not migrated[​](<#tts-voice-not-migrated> "Direct link to TTS voice not migrated")
OpenClaw stores TTS settings in two places: `messages.tts.providers.*` and the top-level `talk` config. The migration checks both. If your voice ID was set via the OpenClaw UI (stored in a different path), you may need to set it manually: `hermes config set tts.elevenlabs.voice_id YOUR_VOICE_ID`.
  ...
  * [What gets migrated](<#what-gets-migrated>)
    * [Persona, memory, and instructions](<#persona-memory-and-instructions>)
    * [Skills (4 sources)](<#skills-4-sources>)
    ...
    * [Archived (no direct Hermes equivalent)](<#archived-no-direct-hermes-equivalent>)
  * [API key resolution](<#api-key-resolution>)
    * [Supported key targets](<#supported-key-targets>)
  ...
  * [Troubleshooting](<#troubleshooting>)
    ...
    * [Skills not appearing after migration](<#skills-not-appearing-after-migration>)
    * [TTS voice not migrated](<#tts-voice-not-migrated>)
