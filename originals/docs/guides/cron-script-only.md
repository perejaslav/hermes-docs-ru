...
## Create One from Chat[​](<#create-one-from-chat> "Direct link to Create One from Chat")
...
### Example transcript[​](<#example-transcript> "Direct link to Example transcript")
...
### What the agent decides for you[​](<#what-the-agent-decides-for-you> "Direct link to What the agent decides for you")
...
### Managing watchdogs from chat[​](<#managing-watchdogs-from-chat> "Direct link to Managing watchdogs from chat")
...
## Create One from the CLI[​](<#create-one-from-the-cli> "Direct link to Create One from the CLI")
...
## How Script Output Maps to Delivery[​](<#how-script-output-maps-to-delivery> "Direct link to How Script Output Maps to Delivery")
...
## Script Rules[​](<#script-rules> "Direct link to Script Rules")
...
## Schedule Syntax[​](<#schedule-syntax> "Direct link to Schedule Syntax")
...
## Editing and Lifecycle[​](<#editing-and-lifecycle> "Direct link to Editing and Lifecycle")
[code] 
...
## Worked Example: Disk Space Alert[​](<#worked-example-disk-space-alert> "Direct link to Worked Example: Disk Space Alert")
[code] 
...
## Comparison with Other Patterns[​](<#comparison-with-other-patterns> "Direct link to Comparison with Other Patterns")
...
For critical system-health watchdogs that must fire _even when the gateway is down_ , keep using OS-level cron + a plain `curl` or `hermes send` call — those run as independent OS processes and don't depend on Hermes being up. The in-gateway scheduler is the right choice when the thing being monitored is external.
## Related[​](<#related> "Direct link to Related")
  ...
  * [Create One from Chat](<#create-one-from-chat>)
    * [Example transcript](<#example-transcript>)
    * [What the agent decides for you](<#what-the-agent-decides-for-you>)
    * [Managing watchdogs from chat](<#managing-watchdogs-from-chat>)
  * [Create One from the CLI](<#create-one-from-the-cli>)
  * [How Script Output Maps to Delivery](<#how-script-output-maps-to-delivery>)
  * [Script Rules](<#script-rules>)
  * [Schedule Syntax](<#schedule-syntax>)
  * [Delivery Targets](<#delivery-targets>)
  * [Editing and Lifecycle](<#editing-and-lifecycle>)
  * [Worked Example: Disk Space Alert](<#worked-example-disk-space-alert>)
